(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=window.location.hostname===`sygec.github.io`||window.location.hostname===`dicethrone-prod.sygec.workers.dev`,t=`https://ojqkkixtvdtccuixishh.supabase.co`,n=`sb_publishable_AT9BZrEkq1IDrZmP1Y_pDQ_Qwnh57ZH`,r=`https://wmxrzjmadvivvpzbslgj.supabase.co`,i=`sb_publishable_Hohs2ojpVd5nmRJoi0upNg_PJv8M7x6`,a=e?t:r,o=e?n:i,s=supabase.createClient(a,o);async function c({email:e,password:t}){return s.auth.signInWithPassword({email:e,password:t})}async function l(e){return s.auth.resetPasswordForEmail(e,{redirectTo:window.location.origin})}async function u({password:e}){return s.auth.updateUser({password:e})}async function d(){return s.auth.signOut()}async function f(){return s.auth.getSession()}function p(e){return s.auth.onAuthStateChange(e)}async function m(){return s.from(`groups`).select(`*`).eq(`is_active`,!0).order(`order_index`,{ascending:!0})}async function h(){let e=await s.from(`players`).select(`*`);return e.data&&e.data.sort((e,t)=>parseInt(e.id.slice(1),10)-parseInt(t.id.slice(1),10)),e}async function g(){return s.from(`heroes`).select(`
    ...
    `,r.querySelector(`.toast-message`).textContent=e,n.appendChild(r),requestAnimationFrame(()=>{r.classList.add(`show`)});let i=()=>{r.parentNode&&(r.classList.remove(`show`),r.addEventListener(`transitionend`,()=>{r.parentNode&&r.parentNode.removeChild(r)}))},a=setTimeout(i,4e3);r.querySelector(`.toast-close`).addEventListener(`click`,()=>{clearTimeout(a),i()})}function D(e,t){return new Promise(n=>{let r=document.createElement(`div`);r.id=`confirm-modal-overlay`,r.innerHTML=`
        ...
        `,r.querySelector(`.confirm-modal-title`).textContent=e,r.querySelector(`.confirm-modal-message`).textContent=t,document.body.appendChild(r),requestAnimationFrame(()=>{r.classList.add(`show`)});let i=()=>{r.classList.remove(`show`),r.addEventListener(`transitionend`,()=>{r.parentNode&&r.parentNode.removeChild(r)})};r.querySelector(`#confirm-cancel-btn`).addEventListener(`click`,()=>{i(),n(!1)}),r.querySelector(`#confirm-confirm-btn`).addEventListener(`click`,()=>{i(),n(!0)}),r.addEventListener(`click`,e=>{e.target===r&&(i(),n(!1))})})}var ve=null,O=()=>(ve||={adminNav:document.querySelector(`.bottom-nav .admin-only`),authBtn:document.getElementById(`auth-btn`),actionButtons:document.getElementById(`action-buttons`),avatarBtn:document.getElementById(`header-avatar-btn`),accountModal:document.getElementById(`account-modal`),loginModal:document.getElementById(`login-modal`),loginError:document.getElementById(`login-error`),loginEmailInput:document.getElementById(`login-email`),updatePasswordModal:document.getElementById(`update-password-modal`),updatePasswordError:document.getElementById(`update-password-error`),updatePasswordUsername:document.getElementById(`update-password-username`),newPasswordInput:document.getElementById(`new-password`),confirmPasswordInput:document.getElementById(`confirm-password`),playerTogglesContainer:document.getElementById(`player-toggle-zone-top`)},ve);function ye(){let e=O(),t=w(`currentUser`),n=w(`loggedInPlayerIndex`),r=w(`NAMES`),i=w(`players`);if(t){if(n!==-1&&r[n])e.authBtn&&(e.authBtn.innerText=`Logout (${r[n]})`);else{let n=t.email?t.email.split(`@`)[0]:`User`;e.authBtn&&(e.authBtn.innerText=`Logout (${n})`)}e.adminNav&&(e.adminNav.style.display=K()?`flex`:`none`);let a=n===-1?null:i[n];e.avatarBtn&&(a?(e.avatarBtn.classList.add(`logged-in`),e.avatarBtn.style.setProperty(`--avatar-color`,`var(--${a.id})`)):(e.avatarBtn.classList.remove(`logged-in`),e.avatarBtn.style.removeProperty(`--avatar-color`)))}else{e.authBtn&&(e.authBtn.innerText=`Login`),e.adminNav&&(e.adminNav.style.display=`none`);let t=document.getElementById(`adminSection`);t&&t.classList.add(`hidden`),e.actionButtons&&(e.actionButtons.style.display=`none`),e.avatarBtn&&(e.avatarBtn.classList.remove(`logged-in`),e.avatarBtn.style.removeProperty(`--avatar-color`))}}function be(){let e=O();e.accountModal&&(e.accountModal.style.display=`flex`),document.body.style.overflow=`hidden`}function xe(){let e=O();e.accountModal&&(e.accountModal.style.display=`none`),document.body.style.overflow=`auto`}function Se(){let e=O(),t=w(`players`);!e.playerTogglesContainer||!t||t.length===0||(e.playerTogglesContainer.innerHTML=t.slice(0,4).map((e,t)=>`
            ...
            </button>`).join(``),et(n)}function et(e=w(`selectedGameType`)){let t=A();if(!t.gameTypeHint)return;let n=e&&Ye[e];if(!n){t.gameTypeHint.style.display=`none`,t.gameTypeHint.innerHTML=``;return}t.gameTypeHint.style.display=`flex`,t.gameTypeHint.innerHTML=`${Ke}<span>${n}</span>`}function tt(e,t,n,r){let i=!!r&&r.team!==e,a=t.map(t=>{let a=n.get(t);if(!a)return``;if(i)return`
        ...
        </div>`}function j(){let e=A();if(!e.teamsStep)return;if(!N(w(`selectedGameType`))){e.teamsStep.style.display=`none`,e.teamSwapScrim.style.display=`none`;return}e.teamsStep.style.display=`block`;let t=w(`teamAssignments`);if(!t){e.teamsGrid.innerHTML=``;return}let n=w(`teamSwapSource`),r=new Map(ft().map(e=>[e.id,e]));e.teamsGrid.innerHTML=tt(`A`,t.teamA,r,n)+tt(`B`,t.teamB,r,n),e.randomizeTeamsBtn.style.display=n?`none`:`block`,e.teamSwapQuestion.style.display=n?`block`:`none`,e.teamSwapQuestion.classList.toggle(`swap-active`,!!n),e.teamSwapScrim.style.display=n?`block`:`none`}var nt=[2,3,4,5];function rt(){let e=A();e.rollModeStep&&e.rollModeStep.classList.toggle(`step-locked`,!w(`selectedGameType`))}function M(){let e=A();if(!e.rollModeGrid)return;let t=w(`rollModeChosen`),n=w(`draftModeEnabled`),r=w(`draftCountChosen`),i=w(`draftCount`),a=!w(`selectedGameType`);e.rollModeGrid.innerHTML=`
        ...
        </button>`,e.draftCountSection.style.display=t&&n?`block`:`none`,e.draftCountGrid.innerHTML=nt.map(e=>`
        <button type="button" class="draft-count-btn${r&&i===e?` active`:``}" data-action="select-draft-count" data-count="${e}">${e}</button>`).join(``)}function it(){let e=A();if(!e.rollStep||!e.rollFinalBtn)return;let t=w(`selectedGameType`),n=w(`rollModeChosen`),r=w(`draftModeEnabled`),i=w(`draftCountChosen`),a=!r||i;if(e.rollStep.classList.toggle(`step-locked`,!t||!n||!a),!t){e.rollFinalBtn.disabled=!0,e.rollFinalBtn.innerHTML=`<span>ROLL &middot; Complete the steps above</span>`;return}if(!n||!a){e.rollFinalBtn.disabled=!0,e.rollFinalBtn.innerHTML=`<span>ROLL &middot; Finish selecting your options above</span>`;return}e.rollFinalBtn.disabled=!1;let o=N(t)?k.teams:k[t],s=Je[t],c=P();e.rollFinalBtn.innerHTML=`${o}<span>ROLL &middot; ${s} &middot; ${c} PLAYER${c===1?``:`S`}</span>`}function at(){let e=document.getElementById(`randomizer-setup`);e&&(e.style.display=`none`);let t=document.getElementById(`team-swap-scrim`);t&&(t.style.display=`none`)}function ot(){let e=document.getElementById(`randomizer-setup`);e&&(e.style.display=`block`);let t=document.getElementById(`results-title`);t&&(t.style.display=`none`)}var st={draft:`ROLL &middot; DRAFT`,confirmation:`ROLL &middot; CONFIRMATION`};function ct(e){let t=document.getElementById(`results-title`);t&&(t.innerHTML=st[e]||``,t.style.display=`block`)}function lt(){Ze(),Qe(),$e(),j(),rt(),M(),it()}var ut=6;function N(e){return e===`2v2`||e===`3v3`}function P(){return document.querySelectorAll(`#player-toggle-zone-top input:checked, #invitee-zone input:checked`).length}function dt(){return document.querySelectorAll(`#player-toggle-zone-top input:checked`).length+w(`invitees`).length<ut}function ft(){let e=w(`players`).slice(0,4),t=w(`invitees`),n=[];return e.forEach((e,t)=>{document.getElementById(`use${t}`)?.checked&&n.push({id:e.id,name:e.name,colorVar:e.id})}),t.forEach(e=>{document.querySelector(`#invitee-zone input[data-invitee-id="${e.id}"]`)?.checked&&n.push({id:e.id,name:e.name,colorVar:`p5`})}),n}function pt(){let e=w(`players`).slice(0,4),t=w(`invitees`),n=[];e.forEach((e,t)=>{document.getElementById(`use${t}`)?.checked&&n.push({pIdx:t,name:e.name,colorVar:e.id,isInvitee:!1})});let r=0;return t.forEach(e=>{document.querySelector(`#invitee-zone input[data-invitee-id="${e.id}"]`)?.checked&&(n.push({pIdx:4+r,name:e.name,colorVar:`p5`,isInvitee:!0}),r++)}),n}function mt(){let e=ft(),t=pt(),n={};return e.forEach((e,r)=>{n[e.id]=`p${t[r].pIdx+1}`}),n}function ht(e){return{duel:e===2,teams:e===4||e===6,ffa:e>=3&&e<=6,koth:e>=3&&e<=6,teamsValue:e===6?`3v3`:`2v2`}}function gt(){if(!dt())return;let e=w(`invitees`);T(`invitees`,[...e,{id:`invitee-${Date.now()}`,name:`Invitee ${e.length+1}`}]),Ze(),F()}function _t(e){T(`invitees`,w(`invitees`).filter(t=>t.id!==e).map((e,t)=>({...e,name:`Invitee ${t+1}`}))),Ze(),F()}function vt(){T(`invitees`,[]),Ze(),F()}function yt(){T(`invitees`,[]),T(`selectedGameType`,null),T(`teamAssignments`,null),T(`teamSwapSource`,null),T(`rollModeChosen`,!1),T(`draftCountChosen`,!1),Ze(),F()}function bt(e){if(!e)return;let t=ht(P());(e===`duel`&&t.duel||e===t.teamsValue&&t.teams||e===`ffa`&&t.ffa||e===`koth`&&t.koth)&&(T(`selectedGameType`,e),T(`teamSwapSource`,null),N(e)?Ct():T(`teamAssignments`,null),$e(),j(),rt(),M(),it())}function F(){let e=P(),t=ht(e),n=w(`selectedGameType`),r=n===`duel`&&t.duel||n===t.teamsValue&&t.teams||n===`ffa`&&t.ffa||n===`koth`&&t.koth;n&&!r&&T(`selectedGameType`,null);let i=w(`selectedGameType`);T(`teamSwapSource`,null),N(i)?Ct():T(`teamAssignments`,null),Qe(e),$e(),j(),rt(),M(),it()}function xt(e){let t=e===`draft`;T(`rollModeChosen`,!0),T(`draftModeEnabled`,t),localStorage.setItem(`draftModeEnabled`,t),M(),it()}function St(e){T(`draftCount`,e),T(`draftCountChosen`,!0),localStorage.setItem(`draftCount`,e),M(),it()}function Ct(){let e=[...ft()].sort(()=>Math.random()-.5),t=e.length/2;T(`teamAssignments`,{teamA:e.slice(0,t).map(e=>e.id),teamB:e.slice(t).map(e=>e.id)}),T(`teamSwapSource`,null),j()}function wt(e,t){T(`teamSwapSource`,{id:e,team:t}),j()}function Tt(){T(`teamSwapSource`,null),j()}function Et(e){let t=w(`teamSwapSource`),n=w(`teamAssignments`);if(!t||!n)return;let{teamA:r,teamB:i}=n,a=t.team===`A`?r:i,o=t.team===`A`?i:r,s=a.indexOf(t.id),c=o.indexOf(e);s===-1||c===-1||(a[s]=e,o[c]=t.id,T(`teamAssignments`,{teamA:r,teamB:i}),T(`teamSwapSource`,null),j())}var Dt=null,I=()=>(Dt||={sortSection:document.getElementById(`sort-section`),sortToggleBtn:document.getElementById(`sort-panel-toggle`),filterSection:document.getElementById(`filter-section`),filterToggleBtn:document.getElementById(`filter-panel-toggle`),sortFilterDrawer:document.getElementById(`sort-filter-drawer`),drawerTitle:document.getElementById(`drawer-title-text`),drawerFooter:document.getElementById(`drawer-footer-content`),drawerBody:document.getElementById(`drawer-body-content`),leftFilterDrawer:document.getElementById(`filter-drawer-left`),leftPlayersContainer:document.getElementById(`filter-options-players`),leftGroupsContainer:document.getElementById(`filter-options-groups`),leftHeroCountLabel:document.getElementById(`filter-drawer-hero-count`),leftTitleDataHistory:document.getElementById(`title-data-history`),leftTitlePlayers:document.getElementById(`title-players`),leftTitleComplexity:document.getElementById(`title-complexity`),leftTitleGroups:document.getElementById(`title-groups`),filterActiveBadge:document.getElementById(`filter-active-badge`),gamesFilterActiveBadge:document.getElementById(`games-filter-active-badge`),sortTriggerBtn:document.getElementById(`btn-trigger-sort`),sortDropdownMenu:document.getElementById(`sort-dropdown-menu`),activeFiltersContainer:document.getElementById(`active-filters-container`),heroContainer:document.getElementById(`heroContainer`),countStatsLabel:document.getElementById(`count-stats`),heroSearchInput:document.getElementById(`hero-search`),dbShowOwnedCheckbox:document.getElementById(`db-show-owned`),dbShowNotOwnedCheckbox:document.getElementById(`db-show-not-owned`)},Dt);function Ot(){let e=I();e.sortFilterDrawer&&(e.drawerTitle&&(e.drawerTitle.innerText=`Filter History`),e.drawerFooter&&(e.drawerFooter.style.display=`flex`),Wt(),e.sortFilterDrawer.classList.add(`open`),document.body.style.overflow=`hidden`)}function kt(){let e=w(`stagedOwnershipFilter`);Object.entries({owned:`pill-show-owned`,unowned:`pill-show-not-owned`,all:`pill-show-all`}).forEach(([t,n])=>{document.getElementById(n)?.classList.toggle(`active`,t===e)}),It()}function At(){Nt(),kt(),Vt(),Ht();let e=I();e.leftFilterDrawer&&(e.leftFilterDrawer.classList.add(`open`),document.body.style.overflow=`hidden`)}function jt(e=null,t=!1){if(e&&e.target!==e.currentTarget&&!t)return;let n=I();n.leftFilterDrawer&&(n.leftFilterDrawer.classList.remove(`open`),document.body.style.overflow=`auto`)}function Mt(e=null,t=!1){if(e&&e.target!==e.currentTarget&&!t)return;let n=I();n.sortFilterDrawer&&(n.sortFilterDrawer.classList.remove(`open`),document.body.style.overflow=`auto`)}function Nt(){let e=I(),t=w(`players`),n=w(`groups`),r=w(`stagedFilterPlayers`),i=w(`stagedFilterGroups`),a=w(`stagedFilterDataHistories`),o=w(`stagedFilterComplexities`);if(e.leftPlayersContainer&&t){let n=t.filter(e=>e.name&&!e.name.toLowerCase().includes(`invitee`)).slice().sort((e,t)=>e.name.localeCompare(t.name));e.leftPlayersContainer.innerHTML=n.map(e=>{let t=r.has(e.id)?`checked`:``;return`
            ...
            `}).join(``)}document.querySelectorAll(`#filter-drawer-left input[data-type="data-history"]`).forEach(e=>{e.checked=a.has(e.value)}),document.querySelectorAll(`#filter-drawer-left input[data-type="complexity"]`).forEach(e=>{e.checked=o.has(Number(e.value))})}function Pt(){let e=I();if(!e.filterActiveBadge)return;let t=w(`activeFilterDataHistories`),n=w(`activeFilterPlayers`),r=w(`activeFilterComplexities`),i=w(`activeFilterGroups`),a=w(`activeOwnershipFilter`),o=0;t&&(o+=t.size),n&&(o+=n.size),r&&(o+=r.size),i&&(o+=i.size),a&&a!==`all`&&o++,o>0?(e.filterActiveBadge.innerText=o,e.filterActiveBadge.style.display=`inline-block`):e.filterActiveBadge.style.display=`none`}function Ft(){let e=I();if(!e.gamesFilterActiveBadge)return;let t=w(`selectedGamePlayerIndex`),n=w(`gamesWinnerOnly`),r=w(`gamesUseHistorical`),i=0;t!==null&&i++,n&&i++,r||i++,i>0?(e.gamesFilterActiveBadge.innerText=i,e.gamesFilterActiveBadge.style.display=`inline-block`):e.gamesFilterActiveBadge.style.display=`none`}function It(){document.querySelectorAll(`.ownership-segmented-control, .segmented-control`).forEach(e=>{let t=e.querySelector(`.segmented-pill.active`),n=e.querySelector(`.segmented-highlight`);n||(n=document.createElement(`div`),n.className=`segmented-highlight`,e.insertBefore(n,e.firstChild)),t&&(n.style.width=`${t.offsetWidth}px`,n.style.transform=`translateX(${t.offsetLeft}px)`,n.style.height=`${t.offsetHeight}px`)})}function Lt(){let e=I();if(!e.sortTriggerBtn)return;let t=w(`currentSort`),n=w(`sortAsc`),r=w(`currentSortPlayerIndex`),i=w(`NAMES`),a=`Hero (A-Z)`;if(t===`name`)a=n?`Hero (A-Z)`:`Hero (Z-A)`;else if(t===`complexity`)a=n?`Complexity (1-6)`:`Complexity (6-1)`;else if(t.startsWith(`w`)){let e=i[r]||`Player ${r+1}`;a=n?`${e} % (Low to High)`:`${e} % (High to Low)`}else if(t.startsWith(`d`)){let e=i[r]||`Player ${r+1}`;a=n?`${e} Played (Oldest)`:`${e} Played (Newest)`}else t===`group`&&(a=n?`Group (A-Z)`:`Group (Z-A)`);e.sortTriggerBtn.innerHTML=`<span class="action-icon">⇅</span> <strong style="font-weight: 700;">SORT:</strong> <span style="font-weight: 400; text-transform: none; margin-left: 2px;">${a}</span>`}function Rt(){let e=I();if(!e.sortDropdownMenu)return;let t=w(`currentSort`),n=w(`sortAsc`),r=w(`activePlayerIndices`),i=w(`NAMES`),a=`
    ...
    `}function Wt(){let e=I();if(!e.drawerBody)return;let t=w(`currentDrawerMode`),n=w(`stagedSort`);w(`stagedSortPlayerIndex`);let r=w(`stagedPlayerIndices`),i=w(`stagedUseHistorical`),a=w(`NAMES`);w(`activePlayerIndices`);let o=w(`stagedBanSearchQuery`);if(e.drawerBody.style.overflowY=`auto`,t===`sort-filter`){e.drawerBody.innerHTML=`
            <div class="panel-row-new">
        ...
        `;let t=`name`;n===`group`?t=`group`:n.startsWith(`w`)?t=`probability`:n.startsWith(`d`)&&(t=`lastPlayed`);let r=document.getElementById(`drawer-sort-type-select`);r&&(r.value=t),Gt(),Kt(),qt(),Xt()}else if(t===`columns`){let t=a.slice(0,4).map((e,t)=>`
        ...
        `}else t===`history-filter`?Ut(e.drawerBody):t===`roll-settings`&&(e.drawerBody.style.overflowY=`hidden`,e.drawerBody.innerHTML=`
        ...
        `,mn())}function Gt(){let e=document.getElementById(`drawer-sort-direction-text`),t=document.getElementById(`drawer-sort-direction-arrow`),n=w(`stagedSortAsc`);e&&t&&(e.innerText=n?`Ascending`:`Descending`,t.innerText=n?`▲`:`▼`)}function Kt(){let e=document.getElementById(`drawer-player-sort-sub-section`),t=document.getElementById(`drawer-player-sort-pills`);if(!e||!t)return;let n=w(`stagedSort`),r=w(`stagedSortPlayerIndex`),i=w(`activePlayerIndices`),a=w(`NAMES`),o=n.startsWith(`w`)||n.startsWith(`d`);e.style.display=o?`block`:`none`,o&&(t.innerHTML=a.slice(0,4).map((e,t)=>`
        ...
        </div>`,e.innerHTML=l}function Jt(e){let t=(e||``).toLowerCase();return t.includes(`season 1`)||t.includes(`s1`)?`group-s1`:t.includes(`season 2`)||t.includes(`s2`)?`group-s2`:t.includes(`marvel`)?`group-marvel`:t.includes(`x-men`)||t.includes(`xmen`)?`group-xmen`:t.includes(`adventures`)?`group-adventures`:t.includes(`solo`)?`group-solo`:t.includes(`outcast`)?`group-outcast`:t.includes(`santa`)||t.includes(`krampus`)||t.includes(`svk`)?`group-svk`:t.includes(`vanguard`)?`group-vanguard`:`group-default`}function Yt(e){if(!e)return`?`;let t=e.trim().toLowerCase();if(t.includes(`season 1`))return`S1`;if(t.includes(`season 2`))return`S2`;if(t.includes(`marvel`))return`MRVL`;if(t.includes(`x-men`)||t.includes(`xmen`))return`XMEN`;if(t.includes(`adventure`))return`ADV`;if(t.includes(`santa`)&&t.includes(`krampus`))return`SvK`;if(t.includes(`solo`))return`SOLO`;if(t.includes(`outcast`))return`OUTC`;if(t.includes(`vanguard`))return`VNGD`;let n=e.split(/\s+/);return n.length>1?n.map(e=>e[0]).join(``).toUpperCase().substring(0,3):e.substring(0,3).toUpperCase()}function Xt(){let e=document.getElementById(`drawer-group-filter-bar`);if(!e)return;let t=document.getElementById(`hero-search`),n=t?t.value.toLowerCase():``,r=document.getElementById(`db-show-owned`)?.checked??!0,i=document.getElementById(`db-show-not-owned`)?.checked??!1,a=w(`stagedLevels`),o=w(`stagedGroups`),s=w(`groups`),c=w(`characters`),l=(e,t)=>t?e.name.toLowerCase().includes(t)||e.group&&e.group.toLowerCase().includes(t):!0,u=s.map(e=>{let t=Yt(e.name),s=o.has(e.id),u=Jt(e.name),d=c.filter(t=>{if(t.group_id!==e.id)return!1;let o=a.has(Number(t.complexity)),s=X(t)&&r||!X(t)&&i;return l(t,n)&&o&&s}).length,f=d===0;return`
    ...
    `}function Zt(){let e=I();if(!e.activeFiltersContainer)return;let t=e.heroSearchInput,n=t?t.value.trim():``,r=w(`activeOwnershipFilter`),i=w(`activeFilterDataHistories`),a=w(`activeFilterPlayers`),o=w(`activeFilterComplexities`),s=w(`activeFilterGroups`),c=w(`players`),l=w(`groups`),u=``;n&&(u+=`
        ...
        `),i&&Array.from(i).sort((e,t)=>{let n=[`Normal only`,`Historical only`];return n.indexOf(e)-n.indexOf(t)}).forEach(e=>{u+=`
            ...
            `}),e.activeFiltersContainer.innerHTML=u,e.activeFiltersContainer.classList.toggle(`has-chips`,!!u.trim())}function Qt(){let e=I();if(!e.heroContainer)return;zi();let t=e.heroSearchInput?.value.toLowerCase()||``,n=e.dbShowOwnedCheckbox?.checked??!0,r=e.dbShowNotOwnedCheckbox?.checked??!1,i=w(`NAMES`),a=w(`characters`),o=w(`activeFilterComplexities`),s=w(`activeFilterGroups`),c=w(`activeFilterDataHistories`),l=w(`activeFilterPlayers`),u=w(`games`),d=w(`activePlayerIndices`),f=w(`currentSort`),p=w(`sortAsc`);w(`currentSortPlayerIndex`);let m=(e,t)=>{if(!t)return!0;let n=t.trim().toLowerCase();return(e.name||``).toLowerCase().includes(n)||(e.group||``).toLowerCase().includes(n)},h=[];t&&i.forEach((e,n)=>{e&&e.toLowerCase().includes(t)&&h.push(n)});let g=[,,,,].fill(0);a.filter(X).forEach(e=>{for(let t=0;t<4;t++)g[t]+=Q(e,t)});let _=a.map((e,t)=>({...e,originalIndex:t})).filter(e=>{let i=!0;o.size>0&&(i=o.has(Number(e.complexity)));let a=!0;s.size>0&&(a=s.has(e.group_id));let d=!0,f=c.has(`Normal only`),p=c.has(`Historical only`);f&&!p?d=u.filter(t=>t.game_players.some(t=>t.hero_id===e.id)).some(e=>!e.is_historical):p&&!f&&(d=u.filter(t=>t.game_players.some(t=>t.hero_id===e.id)).some(e=>e.is_historical));let h=!0;l.size>0&&(h=u.filter(t=>t.game_players.some(t=>t.hero_id===e.id)).some(t=>t.game_players.some(t=>t.hero_id===e.id&&l.has(t.player_id))));let g=X(e)&&n||!X(e)&&r;return m(e,t)&&i&&a&&d&&h&&g});e.countStatsLabel&&(e.countStatsLabel.innerText=`Showing ${_.length} of ${a.length} heroes`),_.sort((e,t)=>{let n,r;if(f.startsWith(`w`)){let i=parseInt(f[1]);n=Q(e,i),r=Q(t,i)}else if(f.startsWith(`d`)){let i=parseInt(f[1]);n=e.lastPlayed&&e.lastPlayed[i]||``,r=t.lastPlayed&&t.lastPlayed[i]||``,(n===`Never`||n===`Unknown`)&&(n=``),(r===`Never`||r===`Unknown`)&&(r=``)}else if(f===`group`){if(n=(e.group||``).toLowerCase(),r=(t.group||``).toLowerCase(),n===r){let n=(e.name||``).toLowerCase(),r=(t.name||``).toLowerCase();return p?n.localeCompare(r):r.localeCompare(n)}}else if(f===`complexity`){if(n=Number(e.complexity)||0,r=Number(t.complexity)||0,n===r){let n=(e.name||``).toLowerCase(),r=(t.name||``).toLowerCase();return n.localeCompare(r)}}else n=(e[f]||``).toLowerCase(),r=(t[f]||``).toLowerCase();if(n===r)return 0;let i=n<r?-1:1;return p?i:-i}),e.heroContainer.innerHTML=_.map(e=>{let t=d;l.size>0?t=Array.from(l).map(e=>parseInt(e.substring(1))-1).filter(e=>e>=0&&e<4):h.length>0&&(t=d.filter(e=>h.includes(e)));let n=t.map(t=>{let n=Q(e,t),r=X(e)&&g[t]>0?(n/g[t]*100).toFixed(2):`0.00`,i=e.playCount&&e.playCount[t]||0,a=e.lastPlayed&&e.lastPlayed[t]||`Never`,o=e.winCount&&e.winCount[t]||0,s=i>0?(o/i*100).toFixed(1):`0.0`;return{p:t,percentage:parseFloat(r),percentageStr:r,playCount:i,lastPlayed:a,winCount:o,winRate:s}});n.sort((e,t)=>{let n=(i[e.p]||``).toLowerCase(),r=(i[t.p]||``).toLowerCase();return n.localeCompare(r)});let r=n.map(e=>{let t=Zi(e.lastPlayed);return`
                ...
                </div>`}).join(``),a=n.map(e=>{let t=Xi(e.lastPlayed),n=Zi(e.lastPlayed),r=t?`<span class="expanded-player-relative">${t} ${n}</span>`:``;return`
    ...
    `}function tn(e){let t=L();if(!t.heroSelectModal)return;t.heroSelectModal.style.display=`flex`,document.body.style.overflow=`hidden`;let n=q(e);t.heroSelectModalTitle&&n?.name&&(t.heroSelectModalTitle.innerText=`Select Hero for ${n.name}`),t.heroSelectSearch&&(t.heroSelectSearch.value=``),T(`modalSortMode`,`name`),rn(`name`),an(),setTimeout(It,50)}function nn(){let e=L();e.heroSelectModal&&(e.heroSelectModal.style.display=`none`),document.body.style.overflow=``}function rn(e){let t=L();t.modalSortName&&t.modalSortName.classList.toggle(`active`,e===`name`),t.modalSortWeight&&t.modalSortWeight.classList.toggle(`active`,e===`weight`),It()}function an(){let e=L();if(!e.heroSelectOptionsContainer)return;let t=w(`activeSelectPlayerIdx`),n=w(`modalSortMode`),r=e.heroSelectSearch,i=r?r.value.toLowerCase().trim():``,a=w(`characters`),o=w(`bannedHeroIds`);if(t===null)return;let s=a.filter(e=>X(e)&&!o.has(e.id));i&&(s=s.filter(e=>e.name.toLowerCase().includes(i)||e.group&&e.group.toLowerCase().includes(i))),n===`name`?s.sort((e,t)=>e.name.localeCompare(t.name)):n===`weight`&&s.sort((e,n)=>{let r=Q(e,t),i=Q(n,t);return r===i?e.name.localeCompare(n.name):i-r});let c=document.getElementById(`select-${t}`)?.value;if(s.length===0){e.heroSelectOptionsContainer.innerHTML=`<p style="opacity: 0.6; font-style: italic; grid-column: 1 / -1; text-align: center; padding: 20px;">No available heroes found.</p>`;return}e.heroSelectOptionsContainer.innerHTML=s.map(e=>{let n=c===e.name,r=qi(e,t);return`
        ...
        <div class="player-row-content">
            <div class="hero-info-container" id="info-container-${e}">
                <div class="hero-header-row">
                    ...
                    <div class="complexity-dice-bar player-row-dice-bar" id="complexity-dice-${e}">${$t(t.complexity)}</div>
                </div>
    ...
    `;let s=document.getElementById(`stats-row-${e}`);if(s)if(e<4){let n=`Prob: <b>${qi(t,e)}</b>`;s.innerHTML=`
                <span>Plays: <b>${t.playCount[e]||0}</b></span>
                <span class="stats-divider">|</span>
                <span>Last: <b>${t.lastPlayed[e]||`Never`}</b></span>
                <span class="stats-divider">|</span>
                <span>${n}</span>
            `}else s.innerHTML=``}function cn(e,t){let n=L();if(!n.resultsDiv)return;let r=e[t],i=q(r)?.name||`Player ${r+1}`,a=e.map((e,n)=>{let r=q(e),i=r?.name||`Player ${e+1}`,a=r?.colorVar||`p${e+1}`,o=n===t;return`
    ...
    `}function ln(e,t){let n=document.getElementById(`draft-card-list`);if(!n)return;let r=``;for(let n=0;n<t;n++)r+=`
            ...
            </div>`;n.innerHTML=r}function un(e,t){let n=document.getElementById(`draft-card-list`);n&&(n.innerHTML=t.map((t,n)=>{let r=e<4?`
                <div class="hero-stats-row">
                    <span>Plays: <b>${t.playCount[e]||0}</b></span>
                    <span class="stats-divider">|</span>
                    <span>Last: <b>${t.lastPlayed[e]||`Never`}</b></span>
                    <span class="stats-divider">|</span>
                    <span>Prob: <b>${qi(t,e)}</b></span>
            ...
            <div class="hero-card draft-card" id="draft-card-${e}-${n}" data-action="select-draft-candidate" data-player-idx="${e}" data-hero-id="${t.id}">
                ...
                <div class="draft-card-content">
                    <div class="draft-card-header">
                        ...
                        <div class="complexity-dice-bar player-row-dice-bar">${$t(t.complexity)}</div>
                    </div>
            ...
            </div>`}).join(``))}function dn(e,t){document.querySelectorAll(`.draft-card[data-player-idx="${e}"]`).forEach(e=>{e.classList.toggle(`selected`,e.dataset.heroId===String(t))})}function fn(e,t){let n=document.getElementById(`draft-confirm-btn`);if(n)if(!t)n.disabled=!0,n.innerText=`SELECT A HERO`;else{let r=q(e)?.name||`Player ${e+1}`;n.disabled=!1,n.innerHTML=`${Z(r.toUpperCase())} picks ${Z(t.name.toUpperCase())} &rarr;`}}function pn(){let e=L();if(!e.rollSettingsBadge||!e.rollSettingsBtn)return;let t=w(`draftModeEnabled`),n=w(`bannedHeroIds`),r=0;t&&r++,n&&n.size>0&&(r+=n.size),r>0?(e.rollSettingsBadge.innerText=r,e.rollSettingsBadge.style.display=`inline-block`,e.rollSettingsBtn.classList.add(`has-settings`)):(e.rollSettingsBadge.style.display=`none`,e.rollSettingsBtn.classList.remove(`has-settings`))}function mn(){let e=L();if(!e.drawerBanListContainer)return;let t=w(`characters`),n=w(`stagedBannedHeroIds`),r=w(`stagedBanSearchQuery`)||``,i=r.toLowerCase().trim(),a=t;i&&(a=t.filter(e=>e.name.toLowerCase().includes(i)||e.group&&e.group.toLowerCase().includes(i)));let o=[...a].sort((e,t)=>e.name.localeCompare(t.name));if(o.length===0){e.drawerBanListContainer.innerHTML=`<p style="opacity: 0.6; font-style: italic; text-align: center; padding: 20px;">No heroes found matching "${r}"</p>`;return}e.drawerBanListContainer.innerHTML=o.map(e=>{let t=n.has(e.id);return`
        ...
        `}).join(``)}var hn=`<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>`;function gn(){let e=w(`characters`),t=w(`bannedHeroIds`),n=pt();if(console.log(`[randomizer] pickCharacters participants:`,n),console.log(`[randomizer] draftModeEnabled:`,w(`draftModeEnabled`)),n.length===0)return alert(`Select players!`);T(`activeRollParticipants`,n);let r=n.map(e=>e.pIdx),i=[...r].sort(()=>Math.random()-.5),a=document.getElementById(`results`);a&&(a.innerHTML=``);let o=e.filter(e=>X(e)&&!t.has(e.id)).map(e=>structuredClone(e));if(console.log(`[randomizer] Owned/non-banned heroes pool count:`,o.length),o.length<r.length)return alert(`Not enough available (owned & non-banned) heroes (${o.length}) in your collection for ${r.length} players!`);if(at(),w(`draftModeEnabled`)){let e=document.getElementById(`action-buttons`);e&&(e.style.display=`none`),T(`activeDraftOrder`,i),T(`activeDraftStep`,0),T(`selectedDraftHeroes`,{}),T(`activeDraftCandidates`,{}),Qr(`roll`),ct(`draft`),a&&a.scrollIntoView({behavior:`smooth`,block:`start`}),jn();return}let s={};i.forEach(e=>{let t=null;if(e>=4){let e=Math.floor(Math.random()*o.length);t=o[e],o.splice(e,1)}else{let n=o.filter(t=>t.weights[e]>0);if(n.length===0){if(o.length>0){let e=Math.floor(Math.random()*o.length);t=o[e],o.splice(e,1)}}else{let r=n.reduce((t,n)=>t+Q(n,e),0),i=Math.random()*r;for(let r of n){let n=Q(r,e);if(i<n){t=r,o.splice(o.findIndex(e=>e.name===r.name),1);break}i-=n}}}s[e]=t});let c=document.getElementById(`action-buttons`);c&&(c.style.display=`none`),T(`isRollActive`,!1);let l=[...r].sort((e,t)=>e-t);l.forEach(e=>{en(e)}),Qr(`roll`),ct(`confirmation`),a&&a.scrollIntoView({behavior:`smooth`,block:`start`});let u=e.filter(e=>X(e)&&!t.has(e.id));l.forEach(e=>{Sn(e,u)});let d=0;function f(){if(d>=i.length){wn(),Bi()?c&&(c.style.display=`flex`):(ot(),vt()),T(`isRollActive`,!0);return}let e=i[d],t=s[e],n=500+Math.random()*500;setTimeout(()=>{Cn(e,t),d++,setTimeout(f,400)},n)}f()}function R(){wn()}function _n(e){T(`activeSelectPlayerIdx`,e),tn(e)}function vn(){nn(),T(`activeSelectPlayerIdx`,null)}function yn(e){T(`modalSortMode`,e),rn(e),bn()}function bn(){an()}function xn(e){let t=w(`activeSelectPlayerIdx`);if(t===null)return;let n=w(`characters`).find(t=>t.name===e);n&&(w(`draftModeEnabled`)&&(w(`selectedDraftHeroes`)[t]=n),on(t,n),wn(),vn())}function Sn(e,t){if(t.length===0)return;let n=document.getElementById(`bg-img-${e}`),r=document.getElementById(`hero-name-title-${e}`);ge(`scrambleIntervals`,e,setInterval(()=>{let e=t[Math.floor(Math.random()*t.length)];if(n&&(n.src=J(e.slug)),r){let e=``;for(let t=0;t<8;t++)e+=`ABCDEFGHIJKLMNOPQRSTUVWXYZ@#$%&*`[Math.floor(Math.random()*32)];r.innerText=e}},70))}function Cn(e,t){let n=w(`scrambleIntervals`);n[e]&&(clearInterval(n[e]),ge(`scrambleIntervals`,e,void 0)),t&&on(e,t)}function wn(){let e=document.querySelectorAll(`.char-select`),t=Array.from(e).map(e=>e.value),n=t.reduce((e,t)=>(e[t]=(e[t]||0)+1,e),{}),r=Object.values(n).some(e=>e>1),i=w(`characters`),a=t.filter(e=>{let t=i.find(t=>t.name===e);return t&&!X(t)}),o=a.length>0,s=document.getElementById(`confirmBtn`),c=document.getElementById(`error-msg`);!s||!c||(s.classList.remove(`disabled`,`warning`),s.disabled=!1,s.innerHTML=`${hn} LOCK IN SESSION`,c.style.display=`none`,r?(s.classList.add(`disabled`),s.disabled=!0,c.style.display=`block`,c.innerText=`⚠ Duplicate hero selected! Each player must have a unique character.`):o&&(s.classList.add(`warning`),s.innerHTML=`⚠️ LOCK IN SESSION`,c.style.display=`block`,c.innerText=`⚠️ You have selected unowned heroes: ${a.join(`, `)}.`),e.forEach(e=>{let t=e.closest(`.player-row`);t&&t.classList.toggle(`error`,n[e.value]>1)}))}async function Tn(){let e=document.getElementById(`confirmBtn`),t=e?e.innerHTML:`Lock In`;e&&(e.disabled=!0,e.innerText=`Saving...`);let n=Array.from(document.querySelectorAll(`.char-select`)).map(e=>e.value),r=w(`characters`),i=n.filter(e=>{let t=r.find(t=>t.name===e);return t&&!X(t)});if(i.length>0&&!await D(`Unowned Heroes Selected`,`You have selected unowned heroes: ${i.join(`, `)}. Do you want to proceed?`)){e&&(e.disabled=!1,e.innerHTML=t);return}let a=document.querySelectorAll(`.char-select`),o=new Map(Array.from(a).map(e=>[parseInt(e.dataset.player),e.value])),s=w(`selectedGameType`),{data:c,error:l}=await C(w(`currentUser`).id,s);if(l)return e&&(e.disabled=!1,e.innerHTML=t),alert(`Error creating game: `+l.message);let u={},d=w(`teamAssignments`);if(N(s)&&d){let n=w(`currentUser`).id,{data:r,error:i}=await ae([{game_id:c.id,team_label:`A`,last_updated_by:n},{game_id:c.id,team_label:`B`,last_updated_by:n}]);if(i)return e&&(e.disabled=!1,e.innerHTML=t),alert(`Error creating teams: `+i.message);let a=mt(),o=Object.fromEntries(r.map(e=>[e.team_label,e.id]));d.teamA.forEach(e=>{u[a[e]||e]=o.A}),d.teamB.forEach(e=>{u[a[e]||e]=o.B})}let{gameParticipants:f,statsUpdates:p}=Wi(r,o,u,c.id,w(`currentUser`).id),{error:m}=await oe(f);if(m)return e&&(e.disabled=!1,e.innerHTML=t),alert(`Error logging game participants: `+m.message);let{error:h}=await se(p);if(h)return e&&(e.disabled=!1,e.innerHTML=t),alert(`Error saving results: `+h.message);await $();let g=document.getElementById(`action-buttons`);g&&(g.style.display=`none`),ot(),vt();let _=document.getElementById(`results`);_&&(_.innerHTML=`
            <p style="color:#28a745; text-align:center; font-weight:bold;">
                Session Logged! Game record created and stats updated.
            </p>`),T(`isRollActive`,!1)}function En(){let e=document.getElementById(`results`);e&&(e.innerHTML=``);let t=document.getElementById(`action-buttons`);t&&(t.style.display=`none`);let n=w(`scrambleIntervals`);n&&(Object.keys(n).forEach(e=>{n[e]&&clearInterval(n[e])}),T(`scrambleIntervals`,{})),T(`activeDraftOrder`,[]),T(`activeDraftStep`,0),T(`selectedDraftHeroes`,{}),T(`activeDraftCandidates`,{}),ot(),Fe(),yt(),T(`isRollActive`,!1)}function Dn(e){E(`stagedBannedHeroIds`,`toggle`,e),mn()}function On(e){T(`stagedBanSearchQuery`,e),mn()}function kn(){pn()}function An(){let e=document.getElementById(`results`);e&&(e.innerHTML=``);let t=w(`selectedDraftHeroes`);[...w(`activeDraftOrder`)].sort((e,t)=>e-t).forEach(e=>{let n=t[e];n&&sn(e,n)})}function jn(){let e=w(`activeDraftStep`),t=w(`activeDraftOrder`),n=w(`characters`),r=w(`bannedHeroIds`),i=w(`selectedDraftHeroes`);if(e>=t.length){An(),ct(`confirmation`),wn();let e=document.getElementById(`action-buttons`);Bi()?e&&(e.style.display=`flex`):(ot(),vt()),T(`isRollActive`,!0);return}let a=t[e];cn(t,e),fn(a,null);let o=Object.values(i).map(e=>e?.name),s=n.filter(e=>X(e)&&!r.has(e.id)&&!o.includes(e.name)),c=w(`draftCount`),l=Math.min(c,s.length);ln(a,l),Nn(a,s,l),setTimeout(()=>{let e=Mn(a,s);w(`activeDraftCandidates`)[a]=e,Pn(a),un(a,e)},1e3)}function Mn(e,t){let n=[],r=[...t],i=w(`draftCount`),a=Math.min(i,r.length);for(let t=0;t<a;t++){let t=null;if(e>=4){let e=Math.floor(Math.random()*r.length);t=r[e],r.splice(e,1)}else{let n=r.filter(t=>t.weights[e]>0);if(n.length===0){if(r.length>0){let e=Math.floor(Math.random()*r.length);t=r[e],r.splice(e,1)}}else{let i=n.reduce((t,n)=>t+Q(n,e),0),a=Math.random()*i;for(let i of n){let n=Q(i,e);if(a<n){t=i,r.splice(r.findIndex(e=>e.name===i.name),1);break}a-=n}}}t&&n.push(t)}return n}function Nn(e,t,n){t.length===0||n===0||ge(`scrambleIntervals`,e,setInterval(()=>{for(let r=0;r<n;r++){let n=t[Math.floor(Math.random()*t.length)];if(!n)continue;let i=document.getElementById(`draft-card-img-${e}-${r}`),a=document.getElementById(`draft-card-name-${e}-${r}`),o=document.getElementById(`draft-card-group-${e}-${r}`);if(i&&(i.src=J(n.slug)),a){let e=``;for(let t=0;t<6;t++)e+=`ABCDEFGHIJKLMNOPQRSTUVWXYZ`[Math.floor(Math.random()*26)];a.innerText=e}o&&(o.innerText=n.group||``)}},70))}function Pn(e){let t=w(`scrambleIntervals`);t[e]&&(clearInterval(t[e]),ge(`scrambleIntervals`,e,void 0))}function Fn(e,t){let n=(w(`activeDraftCandidates`)[e]||[]).find(e=>String(e.id)===String(t));if(!n)return;let r=w(`selectedDraftHeroes`);if(r[e]?.id===n.id){r[e]=null,dn(e,null),fn(e,null);return}r[e]=n,dn(e,n.id),fn(e,n)}function In(e){w(`selectedDraftHeroes`)[e]&&(T(`activeDraftStep`,w(`activeDraftStep`)+1),jn())}function Ln(e){T(`stagedGamesWinnerOnly`,e),B()}function Rn(){T(`currentDrawerMode`,`history-filter`),T(`stagedSelectedGamePlayerIndex`,w(`selectedGamePlayerIndex`)),T(`stagedGamesWinnerOnly`,w(`gamesWinnerOnly`)),T(`stagedGamesUseHistorical`,w(`gamesUseHistorical`)),Ot()}function zn(){T(`stagedFilterDataHistories`,new Set(w(`activeFilterDataHistories`))),T(`stagedFilterPlayers`,new Set(w(`activeFilterPlayers`))),T(`stagedFilterComplexities`,new Set(w(`activeFilterComplexities`))),T(`stagedFilterGroups`,new Set(w(`activeFilterGroups`))),T(`stagedOwnershipFilter`,w(`activeOwnershipFilter`)),At()}function Bn(e){T(`stagedOwnershipFilter`,e),kt(),Vt()}function Vn(e=null,t=!1){jt(e,t)}function Hn(e){let t=e.getAttribute(`data-type`),n=e.value,r=e.checked;if(t===`data-history`)E(`stagedFilterDataHistories`,r?`add`:`delete`,n);else if(t===`player`)E(`stagedFilterPlayers`,r?`add`:`delete`,n);else if(t===`complexity`){let e=Number(n);E(`stagedFilterComplexities`,r?`add`:`delete`,e)}else t===`group`&&E(`stagedFilterGroups`,r?`add`:`delete`,n);Vt(),Ht()}function Un(){w(`stagedFilterDataHistories`).clear(),w(`stagedFilterPlayers`).clear(),w(`stagedFilterComplexities`).clear(),w(`stagedFilterGroups`).clear(),T(`stagedOwnershipFilter`,`all`),document.querySelectorAll(`#filter-drawer-left input[type="checkbox"]`).forEach(e=>{e.checked=!1}),kt(),Vt(),Ht()}function Wn(){T(`activeFilterDataHistories`,new Set(w(`stagedFilterDataHistories`))),T(`activeFilterPlayers`,new Set(w(`stagedFilterPlayers`))),T(`activeFilterComplexities`,new Set(w(`stagedFilterComplexities`))),T(`activeFilterGroups`,new Set(w(`stagedFilterGroups`))),T(`dbUseHistorical`,!w(`activeFilterDataHistories`).has(`Normal only`)||w(`activeFilterDataHistories`).has(`Historical only`));let e=w(`stagedOwnershipFilter`);T(`activeOwnershipFilter`,e),ni(e),Vn(null,!0),H(),V(),ur()}function Gn(){let e=document.getElementById(`hero-search`)?.value.toLowerCase()||``,t=w(`stagedOwnershipFilter`),n=t===`owned`||t===`all`,r=t===`unowned`||t===`all`,i=w(`characters`),a=w(`games`),o=w(`stagedFilterComplexities`),s=w(`stagedFilterGroups`),c=w(`stagedFilterDataHistories`),l=w(`stagedFilterPlayers`);return i.filter(t=>{let i=!0;o.size>0&&(i=o.has(Number(t.complexity)));let u=!0;s.size>0&&(u=s.has(t.group_id));let d=!0,f=c.has(`Normal only`),p=c.has(`Historical only`);f&&!p?d=a.filter(e=>e.game_players.some(e=>e.hero_id===t.id)).some(e=>!e.is_historical):p&&!f&&(d=a.filter(e=>e.game_players.some(e=>e.hero_id===t.id)).some(e=>e.is_historical));let m=!0;l.size>0&&(m=a.filter(e=>e.game_players.some(e=>e.hero_id===t.id)).some(e=>e.game_players.some(e=>e.hero_id===t.id&&l.has(e.player_id))));let h=X(t)&&n||!X(t)&&r;return pr(t,e)&&i&&u&&d&&m&&h}).length}function z(e=null,t=!1){Mt(e,t)}function B(){Wt()}function Kn(e){w(`stagedSelectedGamePlayerIndex`)===e?T(`stagedSelectedGamePlayerIndex`,null):T(`stagedSelectedGamePlayerIndex`,e),w(`stagedSelectedGamePlayerIndex`)===null&&T(`stagedGamesWinnerOnly`,!1),B()}function qn(e){T(`stagedGamesUseHistorical`,e),B()}function Jn(e){e===`name`?T(`stagedSort`,`name`):e===`group`?T(`stagedSort`,`group`):e===`probability`?T(`stagedSort`,`w${w(`stagedSortPlayerIndex`)}`):e===`lastPlayed`&&T(`stagedSort`,`d${w(`stagedSortPlayerIndex`)}`),T(`stagedSortAsc`,e===`name`||e===`group`),Gt(),Kt()}function Yn(e){T(`stagedSortPlayerIndex`,e);let t=w(`stagedSort`);t.startsWith(`w`)?T(`stagedSort`,`w${e}`):t.startsWith(`d`)&&T(`stagedSort`,`d${e}`),Kt()}function Xn(e){let t=w(`stagedPlayerIndices`),n=t.indexOf(e);n>-1?t.splice(n,1):t.push(e),T(`stagedPlayerIndices`,t),B()}function Zn(e){e===`all`?T(`stagedLevels`,w(`stagedLevels`).size===6?new Set:new Set([1,2,3,4,5,6])):E(`stagedLevels`,`toggle`,e),qt(),Xt()}function Qn(e){let t=w(`groups`);e===`all`?w(`stagedGroups`).size===t.length?E(`stagedGroups`,`clear`):t.forEach(e=>E(`stagedGroups`,`add`,e.id)):E(`stagedGroups`,`toggle`,e),qt(),Xt()}function $n(){let e=w(`groups`),t=w(`currentDrawerMode`);t===`sort-filter`?(T(`stagedSort`,`name`),T(`stagedSortAsc`,!0),T(`stagedSortPlayerIndex`,0),T(`stagedLevels`,new Set([1,2,3,4,5,6])),T(`stagedGroups`,new Set(e.map(e=>e.id))),B()):t===`columns`?(T(`stagedPlayerIndices`,[0,1,2,3]),T(`stagedUseHistorical`,!0),B()):t===`history-filter`?(T(`stagedSelectedGamePlayerIndex`,null),T(`stagedGamesWinnerOnly`,!1),T(`stagedGamesUseHistorical`,!0),B()):t===`roll-settings`&&(T(`stagedBannedHeroIds`,new Set),T(`stagedBanSearchQuery`,``),B())}function er(){let e=w(`currentDrawerMode`);e===`sort-filter`?(T(`currentSort`,w(`stagedSort`)),T(`sortAsc`,w(`stagedSortAsc`)),T(`currentSortPlayerIndex`,w(`stagedSortPlayerIndex`)),T(`activeLevels`,new Set(w(`stagedLevels`))),T(`activeGroups`,new Set(w(`stagedGroups`))),V(),z(null,!0),H()):e===`columns`?(T(`activePlayerIndices`,[...w(`stagedPlayerIndices`)]),T(`dbUseHistorical`,w(`stagedUseHistorical`)),V(),z(null,!0),H()):e===`history-filter`?(T(`selectedGamePlayerIndex`,w(`stagedSelectedGamePlayerIndex`)),T(`gamesWinnerOnly`,w(`stagedGamesWinnerOnly`)),T(`gamesUseHistorical`,w(`stagedGamesUseHistorical`)),tr(),z(null,!0),G()):e===`roll-settings`&&(T(`bannedHeroIds`,new Set(w(`stagedBannedHeroIds`))),localStorage.setItem(`bannedHeroIds`,JSON.stringify(Array.from(w(`bannedHeroIds`)))),kn(),z(null,!0))}function V(){Pt()}function tr(){Ft()}function nr(e){let t=w(`currentSort`),n=w(`sortAsc`);t===e?T(`sortAsc`,!n):(T(`currentSort`,e),T(`sortAsc`,!0)),rr(),H()}function rr(){Lt()}function ir(e){zt(e)}function ar(){Bt()}function or(e,t){T(`currentSort`,e),T(`sortAsc`,t),(e.startsWith(`w`)||e.startsWith(`d`))&&T(`currentSortPlayerIndex`,parseInt(e.substring(1))),ar(),rr(),H()}function sr(){let e=document.getElementById(`hero-search`),t=document.getElementById(`clear-search`);e&&t&&t.classList.toggle(`hidden`,e.value.trim().length===0)}function cr(){let e=document.getElementById(`hero-search`);e&&(e.value=``,e.focus()),sr(),lr()}function lr(){H(),ur()}function ur(){Zt()}function dr(e,t){if(e===`data-history`)E(`activeFilterDataHistories`,`delete`,t),T(`dbUseHistorical`,!w(`activeFilterDataHistories`).has(`Normal only`)||w(`activeFilterDataHistories`).has(`Historical only`));else if(e===`player`)E(`activeFilterPlayers`,`delete`,t);else if(e===`complexity`)E(`activeFilterComplexities`,`delete`,t);else if(e===`group`)E(`activeFilterGroups`,`delete`,t);else if(e===`ownership`){T(`activeOwnershipFilter`,`all`),T(`stagedOwnershipFilter`,`all`);let e=document.getElementById(`db-show-owned`),t=document.getElementById(`db-show-not-owned`);e&&(e.checked=!0),t&&(t.checked=!0)}if(e!==`ownership`){let n=document.querySelector(`#filter-drawer-left input[value="${t}"][data-type="${e}"]`);n&&(n.checked=!1)}H(),ur(),V()}function fr(){cr()}function H(){Qt()}function pr(e,t){if(!t)return!0;let n=t.trim().toLowerCase();return(e.name||``).toLowerCase().includes(n)||(e.group||``).toLowerCase().includes(n)}var mr={duel:`1v1 Duel`,"2v2":`Teams 2v2`,"3v3":`Teams 3v3`,ffa:`Free For All`,koth:`King of the Hill`};function hr(e){if(!e)return``;let t=k[e===`2v2`||e===`3v3`?`teams`:e];return t?`<span class="game-card-type-icon" title="${Je[e]||e}">${t}</span>`:``}function gr(e){return e-4+1}var _r=null,U=()=>(_r||={buildInfoDiv:document.getElementById(`admin-build-info`),changelogModal:document.getElementById(`changelog-modal`),changelogContainer:document.getElementById(`changelog-container`),whatsNewModal:document.getElementById(`whats-new-modal`),whatsNewContainer:document.getElementById(`whats-new-container`),collectionContainer:document.getElementById(`collectionContainer`),collectionCountLabel:document.getElementById(`collection-count-stats`),heroForm:document.getElementById(`heroForm`),addHeroBtn:document.getElementById(`addHeroBtn`),groupSelect:document.getElementById(`charGroup`),formTitle:document.getElementById(`formTitle`),charNameInput:document.getElementById(`charName`),charSlugInput:document.getElementById(`charSlug`),charComplexitySelect:document.getElementById(`charComplexity`),groupsListContainer:document.getElementById(`groupsListContainer`),heroesListContainer:document.getElementById(`heroesListContainer`),playersListContainer:document.getElementById(`playersListContainer`),usersListContainer:document.getElementById(`usersListContainer`),collectionsListContainer:document.getElementById(`collectionsListContainer`),gamesListContainer:document.getElementById(`gamesContainer`),winnerModal:document.getElementById(`winner-modal`),winnerContainer:document.getElementById(`winner-selection-container`),confirmWinnerBtn:document.getElementById(`confirm-winner-btn`),groupForm:document.getElementById(`groupForm`),addGroupBtn:document.getElementById(`addGroupBtn`),historyNavBadge:document.getElementById(`history-nav-badge`)},_r);function vr(){let t=U();if(!t.buildInfoDiv)return;let n=window.location.hostname,r=`Localhost`;n.includes(`github.io`)?r=`GitHub Pages`:n.includes(`workers.dev`)&&(r=`Cloudflare Workers`);let i=e?`Production`:`Development`,a=e?`Supabase PROD`:`Supabase DEV`,o=e?`main`:`dev/local`;t.buildInfoDiv.innerHTML=`
    ...
    `).join(``),t.whatsNewModal.style.display=`flex`,document.body.style.overflow=`hidden`)}function Sr(){let e=U();e.whatsNewModal&&(e.whatsNewModal.style.display=`none`),document.body.style.overflow=`auto`}var Cr={roll:{title:`Randomizer`},database:{title:`Heroes`},history:{title:`History`},collection:{title:`Collection`},admin:{title:`Admin`}};function wr(e){let t=Cr[e];if(!t)return;let n=document.getElementById(`header-section-title`);n&&(n.innerText=t.title)}function Tr(){let e=U();if(!e.historyNavBadge)return;let t=Ki(w(`games`));t>0?(e.historyNavBadge.innerText=t>99?`99+`:String(t),e.historyNavBadge.classList.remove(`hidden`)):e.historyNavBadge.classList.add(`hidden`)}function Er(e){if(e===`admin`&&!K())return;let t={roll:`rollSection`,database:`dbSection`,history:`gamesSection`,collection:`collectionSection`,admin:`adminSection`},n=t[e];n&&(Object.values(t).forEach(e=>{let t=document.getElementById(e);t&&(e===n?t.classList.remove(`hidden`):t.classList.add(`hidden`))}),wr(e),document.querySelectorAll(`.bottom-nav .nav-item`).forEach(t=>{t.classList.toggle(`active`,t.getAttribute(`data-section`)===e)}),e===`database`?setTimeout(It,50):e===`history`?Kr():e===`collection`&&kr())}function Dr(e,t){let n=document.getElementById(t),r=(e.currentTarget.closest(`.panel-header`)||e.currentTarget).querySelector(`.panel-toggle`);if(!n||!r)return;let i=n.classList.toggle(`hidden`);r.classList.toggle(`open`,!i),r.setAttribute(`aria-expanded`,String(!i))}function Or(e){let t=e.closest(`.hero-item`),n=e.querySelector(`.panel-toggle`);if(!t||!n)return;let r=t.classList.toggle(`collapsed`);n.classList.toggle(`open`,!r),n.setAttribute(`aria-expanded`,String(!r))}function kr(){let e=U();if(!e.collectionContainer)return;let t=w(`characters`),n=w(`groups`),r=w(`currentUser`),i=w(`expandedCollectionGroups`),a=t.length,o=t.filter(w(`isHeroOwned`)||(e=>e.is_owned)).length;e.collectionCountLabel&&(e.collectionCountLabel.innerText=`Owned ${o} of ${a} heroes`);let s=[...n].sort((e,t)=>{let n=e.order_index??2**53-1,r=t.order_index??2**53-1;return n===r?e.name.localeCompare(t.name):n-r}),c=r?``:`disabled`,l=[];e.collectionContainer.innerHTML=s.map(e=>{let n=t.filter(t=>t.group_id===e.id).sort((e,t)=>e.name.localeCompare(t.name));if(n.length===0)return``;let r=n.every(w(`isHeroOwned`)||(e=>e.is_owned)),a=n.map(e=>{let t=e.is_owned;return`
        ...
        `}).join(``),l.forEach(e=>{let t=document.getElementById(`owned-group-${e}`);t&&(t.indeterminate=!0)})}function Ar(){let e=U();e.charNameInput&&(e.charNameInput.value=``),e.charSlugInput&&(e.charSlugInput.value=``),e.groupSelect&&(e.groupSelect.value=``),e.charComplexitySelect&&(e.charComplexitySelect.value=``),e.formTitle&&(e.formTitle.innerText=`Add New Hero`),e.heroForm&&e.addHeroBtn&&(e.heroForm.classList.add(`hidden`),e.addHeroBtn.innerText=`Add Hero`)}function jr(){let e=U();if(!e.heroForm||!e.addHeroBtn)return;let t=e.heroForm.classList.toggle(`hidden`);e.addHeroBtn.innerText=t?`Add Hero`:`Hide Hero Form`,!t&&e.charNameInput&&e.charNameInput.focus()}function Mr(){let e=U();if(!e.groupSelect)return;let t=w(`groups`).map(e=>`<option value="${e.id}">${e.name}</option>`).join(``);e.groupSelect.innerHTML=`<option value="">-- Select Group --</option>`+t}function Nr(){let e=U();if(!e.groupsListContainer)return;let t=w(`groups`);if(t.length===0){e.groupsListContainer.innerHTML=`<p style="opacity: 0.6; font-style: italic;">No groups yet. Create one above.</p>`;return}let n=t.map(e=>`
    ...
    `).join(``);e.groupsListContainer.innerHTML=n}function Pr(){let e=U();if(!e.heroesListContainer)return;let t=w(`characters`),n=w(`editIndex`),r=w(`groups`);if(t.length===0){e.heroesListContainer.innerHTML=`<p style="opacity: 0.6; font-style: italic;">No heroes yet. Add one above.</p>`;return}let i=t.map((e,t)=>{let i=n===t,a=K()?`<button class="btn-save btn-inline" data-action="edit-hero" data-hero-idx="${t}">Edit</button>`:``,o=K()?`<button class="btn-cancel btn-inline" data-action="delete-hero" data-hero-id="${e.id}">Delete</button>`:``,s=r.map(t=>`<option value="${t.id}" ${t.id===e.group_id?`selected`:``}>${Z(t.name)}</option>`).join(``);return`
            ...
            </div>`}).join(``);e.heroesListContainer.innerHTML=i,n===-1?e.heroesListContainer.classList.remove(`group-edit-active`):e.heroesListContainer.classList.add(`group-edit-active`)}function Fr(e){let t=document.getElementById(`groupEditPanel-${e}`),n=document.getElementById(`groupRow-${e}`);t&&t.classList.add(`hidden`),n&&n.classList.remove(`editing`);let r=U().groupsListContainer;r&&(r.querySelectorAll(`.group-row.editing`).length>0||r.classList.remove(`group-edit-active`))}function Ir(){let e=document.getElementById(`groupName`),t=document.getElementById(`groupOrder`),n=document.getElementById(`groupYear`);e&&(e.value=``),t&&(t.value=``),n&&(n.value=``);let r=U().groupForm,i=U().addGroupBtn;r&&i&&(r.classList.add(`hidden`),i.innerText=`Add Group`)}function Lr(){let e=U().groupForm,t=U().addGroupBtn;if(!e||!t)return;let n=e.classList.toggle(`hidden`);if(t.innerText=n?`Add Group`:`Hide Group Form`,!n){let e=document.getElementById(`groupName`);e&&e.focus()}}function Rr(){let e=U();if(!e.playersListContainer)return;let t=w(`players`);if(t.length===0){e.playersListContainer.innerHTML=`<p style="opacity: 0.6; font-style: italic;">No players loaded.</p>`;return}let n=t.map((e,t)=>{let n=Hi(e);return`
            ...
            </div>`}).join(``);e.playersListContainer.innerHTML=n}function zr(e){let t=document.getElementById(`playerEditPanel-${e}`),n=document.getElementById(`playerRow-${e}`);t&&t.classList.add(`hidden`),n&&n.classList.remove(`editing`);let r=U().playersListContainer;r&&(r.querySelectorAll(`.player-admin-row.editing`).length>0||r.classList.remove(`player-edit-active`))}function Br(){let e=U();if(!e.usersListContainer)return;let t=w(`authUsers`);if(t.length===0){e.usersListContainer.innerHTML=`<p style="opacity: 0.6; font-style: italic;">No system users loaded.</p>`;return}let n=t.map(e=>{let t=e.role||`user`,n=t===`admin`;return`
            ...
            </div>`}).join(``);e.usersListContainer.innerHTML=n}function Vr(e,t){let n=U();if(!n.collectionsListContainer)return;if(e.length===0){n.collectionsListContainer.innerHTML=`<p style="opacity: 0.6; font-style: italic;">No collections loaded.</p>`;return}let r=w(`characters`),i={};t.forEach(e=>{i[`${e.user_id}_${e.hero_id}`]=e.is_owned});let a=document.createElement(`div`);a.style.overflowX=`auto`,a.style.marginTop=`10px`,a.innerHTML=`
    ...
    `,n.collectionsListContainer.innerHTML=``,n.collectionsListContainer.appendChild(a)}function Hr(e,t){return e.game_players.map(e=>{let n=parseInt(e.player_id.substring(1))-1,r=e.heroes?.name||`Unknown`,i=e.heroes?.slug||``,a=e.is_winner===!0,o=a?`checked`:``,s=a?`selected`:``,c=t[n]||`Invitee`;return n>=4&&(c=`Invitee (${gr(n)})`),`
        ...
        `}).join(``)}function Ur(e,t){let n={A:[],B:[]};return e.game_players.forEach(e=>{let t=e.teams?.team_label;t&&n[t]&&n[t].push(e)}),[`A`,`B`].filter(e=>n[e].length>0).map(e=>{let r=n[e],i=r.some(e=>e.is_winner===!0);return`
    ...
    `,t.winnerModal.style.display=`flex`,document.body.style.overflow=`hidden`}function Gr(){let e=U();e.winnerModal&&(e.winnerModal.style.display=`none`),document.body.style.overflow=`auto`}function Kr(){let e=U();if(!e.gamesListContainer)return;let t=w(`games`);w(`players`);let n=w(`NAMES`),r=w(`expandedGameIds`),i=w(`selectedGamePlayerIndex`),a=w(`gamesWinnerOnly`),o=w(`gamesUseHistorical`),s=w(`gamesHistoryStyle`)||`gorgeous`,c=document.getElementById(`games-search`),l=c?c.value.toLowerCase().trim():``,u=s===`gorgeous`,d=e=>{let n=document.getElementById(`game-count-stats`);n&&(n.innerText=`Showing ${e} of ${t?t.filter(e=>u?!e.is_historical:o||!e.is_historical).length:0} games`)},f=``;if(K()&&(f=`
        ...
        `),!t||t.length===0){e.gamesListContainer.innerHTML=f+`<p style="opacity: 0.7; font-style: italic; text-align: center; padding: 20px;">No games played yet.</p>`,d(0);return}let p=t.filter(e=>{if(u&&e.is_historical||!u&&!o&&e.is_historical)return!1;let t=!0;return i!==null&&(t=e.game_players.some(e=>{let t=parseInt(e.player_id.substring(1))-1,n=!1;return i>=0&&i<4?n=t===i:i===4&&(n=t>=4),n&&a?e.is_winner===!0:n})),!(!t||l&&!(e.game_players||[]).map(e=>e.heroes?.name||``).join(` `).toLowerCase().includes(l))});if(p.length===0){e.gamesListContainer.innerHTML=f+`<p style="opacity: 0.7; font-style: italic; text-align: center; padding: 20px;">No matches found matching filter criteria.</p>`,d(0);return}d(p.length),u?e.gamesListContainer.innerHTML=f+p.map(e=>{let a=e.played_at||``;a&&!a.includes(`T`)&&(a=a.replace(` `,`T`)),a&&!a.includes(`Z`)&&!a.includes(`+`)&&(a+=`Z`);let o=new Date(a).toLocaleDateString(void 0,{dateStyle:`medium`}),s=new Date(a).toLocaleTimeString(void 0,{timeStyle:`short`}),c=e.game_type===`2v2`||e.game_type===`3v3`,u=hr(e.game_type),d=e.game_type?`<div class="game-card-type-badge">${mr[e.game_type]||e.game_type}</div>`:``,f=e.game_players.filter(e=>e.is_winner===!0),p=e.game_players.filter(e=>e.is_winner===!1),m=f.length===0&&p.length>0&&p.length===e.game_players.length,h=f.length===0&&!m,g=r.has(e.id)?`expanded`:``,_=h?`in-progress`:``,v=``;f.length>0&&f[0].heroes?.slug&&(v=`<img src="${J(f[0].heroes.slug)}" class="game-card-bg-img" alt="">`);let y={};e.game_players.forEach(e=>{let t=parseInt(e.player_id.substring(1))-1,r;t>=4?r=`Invitee ${gr(t)}`:(r=n[t]||`Unknown`,r.toLowerCase().startsWith(`player `)&&r.length>7&&(r=`P`+r.substring(7))),y[e.player_id]=r});let b=Object.values(y).map(e=>e.charAt(0).toUpperCase()),x={};e.game_players.forEach(e=>{let t=y[e.player_id],n=t.charAt(0).toUpperCase(),r=b.filter(e=>e===n).length,i=n;r>1&&t.length>1&&(i=n+t.charAt(1).toLowerCase()),x[e.player_id]=i});let ee=[...e.game_players].sort((e,t)=>e.is_winner&&!t.is_winner?-1:!e.is_winner&&t.is_winner?1:0).map(e=>{let t=parseInt(e.player_id.substring(1))-1,n=e.heroes?.slug||``,r=e.heroes?.name||`Unknown`,i=e.is_winner===!0,a=i?`winner-highlight`:``,o=i?`<span class="mini-winner-trophy">🏆</span>`:``,s=x[e.player_id];return`
                ...
                <div class="game-history-card ${g} ${_}">
                    ...
                    `});let f=Bi()&&d?`<button type="button" class="btn-save btn-inline" data-action="open-winner-modal" data-game-id="${e.id}">Select Winner</button>`:``,p=K()?`<button type="button" class="btn-cancel btn-inline" data-action="delete-game" data-game-id="${e.id}">Delete</button>`:``,m=e.is_historical?`<span style="font-size: 0.7em; letter-spacing: 0.5px; opacity: 0.5; padding: 2px 6px; border: 1px solid rgba(255,255,255,0.2); border-radius: 4px; font-weight: 500; font-family: monospace;">HISTORICAL</span>`:``;return`
                ...
                </div>`}).join(``)}function qr(){vr()}function Jr(){yr()}function Yr(){br()}function Xr(e){xr(e),localStorage.setItem(`lastSeenVersion`,e[0].version)}function Zr(){Sr()}function Qr(e){Er(e)}function $r(e,t){Dr(e,t)}function ei(e){Or(e)}function ti(e,t){t.target.tagName===`INPUT`||t.target.tagName===`LABEL`||t.target.closest(`label`)||(E(`expandedCollectionGroups`,`toggle`,e),W())}function ni(e){let t=document.getElementById(`db-show-owned`),n=document.getElementById(`db-show-not-owned`);t&&n&&(e===`owned`?(t.checked=!0,n.checked=!1):e===`unowned`?(t.checked=!1,n.checked=!0):(t.checked=!0,n.checked=!0)),H()}function W(){kr()}async function ri(e,t){if(!w(`currentUser`)){alert(`Please log in to manage your collection.`);return}let n=w(`characters`).find(t=>t.id===e);n&&(n.is_owned=t),W(),H(),R();let r=document.getElementById(`admin-owned-${w(`currentUser`).id}-${e}`);r&&(r.checked=t);let{error:i}=await x(w(`currentUser`).id,e,t);i&&(alert(`Error updating ownership: `+i.message),n&&(n.is_owned=!t),W(),R(),H(),r&&(r.checked=!t))}async function ii(e,t){if(!w(`currentUser`)){alert(`Please log in to manage your collection.`);return}let n=w(`characters`);n.forEach(n=>{if(n.group_id===e){n.is_owned=t;let e=document.getElementById(`admin-owned-${w(`currentUser`).id}-${n.id}`);e&&(e.checked=t)}}),W(),H(),R();let{error:r}=await ee(n.filter(t=>t.group_id===e).map(e=>({user_id:w(`currentUser`).id,hero_id:e.id,is_owned:t})));r&&(alert(`Error updating group ownership: `+r.message),n.forEach(n=>{n.group_id===e&&(n.is_owned=!t)}),W(),R(),H())}async function ai(){let e=document.getElementById(`charName`).value.trim(),t=document.getElementById(`charGroup`).value,n=document.getElementById(`charSlug`).value.trim(),r=document.getElementById(`charComplexity`).value.trim();if(!e)return alert(`Name is required`);if(!t)return alert(`Group is required`);let{error:i}=await te({name:e,slug:n,complexity:r?parseInt(r):null,group_id:t,last_updated_by:w(`currentUser`).id});if(i)return alert(`Error saving: `+i.message);await $(),ci()}function oi(e){T(`editIndex`,e),fi(),document.getElementById(`adminSection`).classList.contains(`hidden`)&&Qr(`admin`);let t=w(`characters`),n=document.getElementById(`heroEditPanel-${t[e]?.id}`);n&&!si(n)&&n.scrollIntoView({behavior:`smooth`,block:`nearest`})}function si(e){let t=e.getBoundingClientRect();return t.top>=0&&t.left>=0&&t.bottom<=(window.innerHeight||document.documentElement.clientHeight)}function ci(){T(`editIndex`,-1),Ar()}function li(){jr()}function ui(){Mr()}function di(){Nr()}function fi(){Pr()}function pi(){T(`editIndex`,-1),fi()}async function mi(e,t){let n=document.getElementById(`heroName-${t}`).value.trim(),r=document.getElementById(`heroGroup-${t}`).value,i=document.getElementById(`heroSlug-${t}`).value.trim(),a=document.getElementById(`heroComplexity-${t}`).value.trim();if(!n)return alert(`Name is required`);if(!r)return alert(`Group is required`);let{error:o}=await ne({id:e,name:n,slug:i,complexity:a?parseInt(a):null,group_id:r,last_updated_by:w(`currentUser`).id});if(o)return alert(`Error saving: `+o.message);T(`editIndex`,-1),await $()}async function hi(e){if(!await D(`Delete Hero`,`Delete this hero? This action cannot be undone.`))return;let{error:t}=await re(e);if(t)return alert(`Error deleting hero: `+t.message);await $()}async function gi(){let e=document.getElementById(`groupName`).value.trim(),t=document.getElementById(`groupOrder`).value.trim(),n=document.getElementById(`groupYear`).value.trim();if(!e)return alert(`Group name is required`);let{error:r}=await ie({name:e,order_index:t?parseInt(t):null,year:n?parseInt(n):null,is_active:!0});if(r)return alert(`Error saving group: `+r.message);bi(),$()}function _i(e){let t=w(`groups`).find(t=>t.id===e);if(!t)return;let n=document.getElementById(`groupsListContainer`);n&&(n.classList.add(`group-edit-active`),n.querySelectorAll(`.group-row`).forEach(e=>e.classList.remove(`editing`)));let r=document.getElementById(`groupEditPanel-${e}`),i=document.getElementById(`groupRow-${e}`);!r||!i||(i.classList.add(`editing`),document.getElementById(`groupName-${e}`).value=t.name,document.getElementById(`groupOrder-${e}`).value=t.order_index||``,document.getElementById(`groupYear-${e}`).value=t.year||``,r.classList.remove(`hidden`))}function vi(e){Fr(e)}async function yi(e){let t=document.getElementById(`groupName-${e}`).value.trim(),n=document.getElementById(`groupOrder-${e}`).value.trim(),r=document.getElementById(`groupYear-${e}`).value.trim();if(!t)return alert(`Group name is required`);let{error:i}=await ie({id:e,name:t,order_index:n?parseInt(n):null,year:r?parseInt(r):null,is_active:!0});if(i)return alert(`Error saving group: `+i.message);$()}function bi(){Ir()}function xi(){Lr()}function Si(){Rr()}function Ci(e){let t=w(`players`).find(t=>t.id===e);if(!t)return;let n=document.getElementById(`playersListContainer`);n&&(n.classList.add(`player-edit-active`),n.querySelectorAll(`.player-admin-row`).forEach(e=>e.classList.remove(`editing`)));let r=document.getElementById(`playerEditPanel-${e}`),i=document.getElementById(`playerRow-${e}`);!r||!i||(i.classList.add(`editing`),document.getElementById(`playerName-${e}`).value=t.name,r.classList.remove(`hidden`))}function wi(e){zr(e)}async function Ti(e){let t=document.getElementById(`playerName-${e}`).value.trim();if(!t)return alert(`Player name is required`);let{error:n}=await b(e,t);if(n)return alert(`Error saving player: `+n.message);let r=w(`players`),i=w(`NAMES`),a=r.findIndex(t=>t.id===e);a!==-1&&(r[a].name=t,i[a]=t),wi(e),Si()}function Ei(){Br()}async function Di(){let e=document.getElementById(`collectionsListContainer`);if(!e)return;e.innerHTML=`<p style="opacity: 0.7; font-style: italic; padding: 10px;">Loading collections...</p>`;let t=[];try{let{data:n,error:r}=await v();if(r){e.innerHTML=`<p style="color: var(--danger); padding: 10px;">Error loading collections: ${Z(r.message)}</p>`;return}t=n||[]}catch(t){e.innerHTML=`<p style="color: var(--danger); padding: 10px;">Error connecting to database: ${Z(t.message)}</p>`;return}let n=[],r=w(`players`);r.forEach(e=>{e.user_id&&n.push({user_id:e.user_id,name:e.name,isLinked:!0})}),t.forEach(e=>{n.some(t=>t.user_id===e.user_id)||n.push({user_id:e.user_id,name:`User (${e.user_id.substring(0,8)})`,isLinked:!1})});let i=w(`currentUser`);if(i&&!n.some(e=>e.user_id===i.id)){let e=r.find(e=>e.user_id===i.id),t=e?e.name:i.email?i.email.split(`@`)[0]:`Admin`;n.push({user_id:i.id,name:t,isLinked:!!e})}Vr(n,t)}async function Oi(e,t,n){let r=w(`currentUser`);if(e===r?.id){let e=w(`characters`).find(e=>e.id===t);e&&(e.is_owned=n),W(),H(),R()}let{error:i}=await x(e,t,n);if(i){if(alert(`Error updating user collection: `+i.message),e===r?.id){let e=w(`characters`).find(e=>e.id===t);e&&(e.is_owned=!n),W(),H(),R()}Di()}}async function ki(e){if(!await D(`Delete Group`,`Delete this group?`))return;let{error:t}=await S(e);if(t)return alert(`Error deleting group: `+t.message);bi(),$()}function G(){Kr()}function Ai(){Tr()}function ji(){let e=document.getElementById(`games-search`),t=document.getElementById(`clear-games-search`);e&&t&&t.classList.toggle(`hidden`,e.value.trim().length===0),G()}function Mi(){let e=document.getElementById(`games-search`);e&&(e.value=``,e.focus()),ji()}function Ni(e){E(`expandedGameIds`,`toggle`,e),G()}function Pi(){T(`gamesHistoryStyle`,(w(`gamesHistoryStyle`)||`gorgeous`)===`gorgeous`?`admin`:`gorgeous`),G()}function Fi(e){Wr(e)}function Ii(){Gr()}async function Li(e){let t=document.querySelector(`input[name="winner-selection"]:checked`);if(!t)return alert(`Please select a winner.`);let n=t.value,r=document.getElementById(`confirm-winner-btn`);r.disabled=!0,r.innerText=`Saving...`;let i=w(`games`).find(t=>t.id===e),a=i?.game_type===`2v2`||i?.game_type===`3v3`;try{let{error:t}=a?await le(e,n,w(`currentUser`).id):await ce(e,n,w(`currentUser`).id);if(t)throw t;Ii(),await $()}catch(e){alert(`Error updating winner: `+e.message)}finally{r.disabled=!1,r.innerText=`Save Result`}}async function Ri(e){if(!await D(`Delete Game Record`,`Are you sure you want to delete this game record? This cannot be undone.`))return;let{error:t}=await ue(e);if(t)return console.error(`Error deleting game:`,t),alert(`Failed to delete game: `+t.message);await $()}function zi(){let e=!0,t=!0,n=w(`activeFilterDataHistories`),r=n.has(`Normal only`),i=n.has(`Historical only`);r&&!i?(e=!0,t=!1):i&&!r&&(e=!1,t=!0);let a=w(`characters`);a.forEach(e=>{e.playCount=[0,0,0,0],e.lastPlayed=[`Never`,`Never`,`Never`,`Never`],e.winCount=[0,0,0,0]});let o=w(`games`);o&&o.forEach(n=>{let r=!!n.is_historical;r&&!t||!r&&!e||n.game_players.forEach(e=>{let t=parseInt(e.player_id?.substring(1)||`0`,10)-1;if(t>=0&&t<4){let r=a.find(t=>t.id===e.hero_id);if(!r)return;if(r.playCount[t]++,e.is_winner&&r.winCount[t]++,r.lastPlayed[t]===`Never`){let e=n.played_at||``;e&&!e.includes(`T`)&&(e=e.replace(` `,`T`)),e&&!e.includes(`Z`)&&!e.includes(`+`)&&(e+=`Z`);let i=new Date(e);r.lastPlayed[t]=i.getFullYear()<2026?`Unknown`:i.toLocaleDateString(`en-CA`)}}})})}window.alert=function(e){_e(e,e&&(e.toLowerCase().includes(`error`)||e.toLowerCase().includes(`failed`))?`error`:`warning`)};function K(){return w(`currentUser`)?.app_metadata?.role===`admin`}function Bi(){return!!w(`currentUser`)}function q(e){return w(`activeRollParticipants`).find(t=>t.pIdx===e)}var J=e=>e?`https://dice-throne.rulepop.com/heroes/${e}.webp`:``,Y=e=>`https://dice-throne.rulepop.com/#hero/${e}`,X=e=>!!e?.is_owned,Z=e=>String(e||``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#039;`),Vi=e=>{if(!e)return`#ffffff`;if(e=e.trim(),e.startsWith(`#`))return e;let t=e.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);if(t){let e=parseInt(t[1],10),n=parseInt(t[2],10),r=parseInt(t[3],10);return`#${(1<<24|e<<16|n<<8|r).toString(16).slice(1)}`}return e},Hi=e=>e?.player_color?Vi(e.player_color):Vi(getComputedStyle(document.documentElement).getPropertyValue(`--${e?.id}`).trim()),Ui=(e,t)=>{document.documentElement.style.setProperty(`--${e}`,t)};function Q(e,t){return e.weights[t]/(e.playCount[t]*3+1)**2}function Wi(e,t,n,r,i){let a=[],o=[];return e.forEach(e=>{t.forEach((t,s)=>{if(t===e.name&&a.push({game_id:r,player_id:`p${s+1}`,hero_id:e.id,is_winner:null,team_id:n[`p${s+1}`]||null,last_updated_by:i}),s>=4)return;let c=t===e.name?20:(e.weights[s]||250)+10;o.push({hero_id:e.id,player_id:`p${s+1}`,weight:c,last_updated_by:i})})}),{gameParticipants:a,statsUpdates:o}}function Gi(e){let t=e.game_players||[];if(t.filter(e=>e.is_winner===!0).length>0)return!1;let n=t.filter(e=>e.is_winner===!1);return!(n.length>0&&n.length===t.length)}function Ki(e){return(e||[]).filter(e=>!e.is_historical&&Gi(e)).length}function qi(e,t){if(!e)return`0.00%`;let n=w(`characters`).filter(X).length;if(n===0)return`0.00%`;if(t>=4)return`${(100/n).toFixed(2)}%`;let r=0;if(w(`characters`).filter(X).forEach(e=>r+=Q(e,t)),r===0)return`0.00%`;let i=X(e),a=Q(e,t);return`${i?(a/r*100).toFixed(2):`0.00`}%`}async function Ji(e,t){let n=w(`players`).find(t=>t.id===e);if(!n)return;let r=Hi(n),i=Vi(t.value);if(i.toLowerCase()===r.toLowerCase())return;if(!await D(`Change Player Color`,`Change ${n.name}'s color from ${r} to ${i}?`)){t.value=r;return}let{error:a}=await y(e,i);if(a){alert(`Error saving player color: `+a.message),t.value=r;return}let o=w(`players`).findIndex(t=>t.id===e);o!==-1&&(w(`players`)[o].player_color=i),Ui(e,i),Si()}function Yi(e){if(!e)return null;try{let t=e.trim();t&&!t.includes(`T`)&&(t=t.replace(` `,`T`)),t&&t.includes(`:`)&&!t.includes(`Z`)&&!t.includes(`+`)&&(t+=`Z`);let n=new Date(t);return isNaN(n.getTime())?null:n}catch{return null}}function Xi(e){if(!e||e===`Never`)return``;if(e===`Unknown`)return`Date unknown (historical)`;let t=Yi(e);if(!t)return``;try{let e=new Date;t.setHours(0,0,0,0),e.setHours(0,0,0,0);let n=e-t,r=Math.floor(n/(1e3*60*60*24));return r<0?``:r===0?`today`:r===1?`yesterday`:`${r} days ago`}catch{return``}}function Zi(e){let t=`⚫`;if(e&&e===`Unknown`)t=`🔴`;else if(e&&e!==`Never`&&e!==`Unknown`){let n=Yi(e);if(n)try{let e=new Date;n.setHours(0,0,0,0),e.setHours(0,0,0,0);let r=e-n,i=Math.floor(r/(1e3*60*60*24));t=i<=15?`🟢`:i<=60?`🟡`:`🔴`}catch{t=`⚪`}else t=`⚪`}return t}function Qi(){let e=(e,t)=>{let n=document.getElementById(e);n&&n.addEventListener(`click`,t)};e(`roll-final-btn`,gn),e(`cancelBtn`,En),e(`confirmBtn`,Tn),e(`clear-search`,cr),e(`hero-search-btn`,lr),e(`btn-trigger-sort`,ir),e(`btn-trigger-filter`,zn),e(`clear-games-search`,Mi),e(`btn-trigger-games-filter`,Rn);let t=document.getElementById(`randomizer-setup`);t&&(t.addEventListener(`change`,e=>{let t=e.target.closest(`#invitee-zone input[data-invitee-id]`);if(t&&!t.checked)return _t(t.dataset.inviteeId);e.target.closest(`#player-toggle-zone-top, #invitee-zone`)&&F()}),t.addEventListener(`click`,e=>{if(e.target.closest(`[data-action="add-invitee"]`))return gt();let t=e.target.closest(`[data-action="select-game-type"]`);if(t&&!t.disabled)return bt(t.dataset.type);if(e.target.closest(`[data-action="randomize-teams"]`))return Ct();let n=e.target.closest(`[data-action="initiate-team-swap"]`);if(n)return wt(n.dataset.participantId,n.dataset.team);let r=e.target.closest(`[data-action="complete-team-swap"]`);if(r)return Et(r.dataset.participantId);let i=e.target.closest(`[data-action="select-roll-mode"]`);if(i&&!i.disabled)return xt(i.dataset.mode);let a=e.target.closest(`[data-action="select-draft-count"]`);if(a)return St(parseInt(a.dataset.count,10))}));let n=document.getElementById(`team-swap-scrim`);n&&n.addEventListener(`click`,()=>Tt()),document.querySelectorAll(`.bottom-nav .nav-item`).forEach(e=>{e.addEventListener(`click`,t=>{t.preventDefault();let n=e.getAttribute(`data-section`);n&&Qr(n)})});let r=document.getElementById(`version-number`);r&&r.addEventListener(`click`,()=>{ze(),Jr()});let i=document.querySelector(`.close-button`);i&&i.addEventListener(`click`,Yr),e(`whats-new-close`,Zr),e(`whats-new-got-it`,Zr),e(`winner-close`,Ii),e(`winner-cancel`,Ii),e(`login-close`,Le),e(`forgot-password-btn`,Ve),e(`update-password-close`,Ue),e(`hero-select-close`,vn),e(`header-avatar-btn`,Re),e(`account-close`,ze);let a=document.getElementById(`hero-search`);a&&(a.addEventListener(`keydown`,e=>{e.key===`Enter`&&lr()}),a.addEventListener(`input`,sr));let o=document.getElementById(`games-search`);o&&o.addEventListener(`input`,ji);let s=document.getElementById(`hero-select-search`);s&&s.addEventListener(`input`,bn);let c=document.getElementById(`modal-sort-name`);c&&c.addEventListener(`click`,()=>yn(`name`));let l=document.getElementById(`modal-sort-weight`);l&&l.addEventListener(`click`,()=>yn(`weight`));let u=document.getElementById(`sort-filter-drawer`);u&&u.addEventListener(`click`,e=>{z(e)});let d=document.getElementById(`filter-drawer-left`);d&&d.addEventListener(`click`,e=>{let t=e.target.closest(`.segmented-pill[data-filter]`);if(t){let e=t.getAttribute(`data-filter`);e&&Bn(e);return}Vn(e)}),e(`drawer-close`,()=>z(null,!0)),e(`drawer-reset`,$n),e(`drawer-apply`,er),e(`filter-drawer-close-btn`,Wn),e(`filter-drawer-reset`,Un),e(`filter-drawer-apply`,Wn),e(`addGroupBtn`,xi),e(`saveGroupBtn`,gi);let f=document.getElementById(`cancelGroupBtn`);f&&f.addEventListener(`click`,async()=>{document.getElementById(`groupName`).value&&!await D(`Discard Changes`,`Discard unsaved changes?`)||bi()}),e(`addHeroBtn`,li),e(`saveBtn`,ai);let p=document.getElementById(`cancelHeroBtn`);p&&p.addEventListener(`click`,async()=>{document.getElementById(`charName`).value&&!await D(`Discard Changes`,`Discard unsaved changes?`)||ci()}),document.querySelectorAll(`#adminSection .panel-header`).forEach(e=>{e.addEventListener(`click`,t=>{let n=e.getAttribute(`data-panel`);n&&$r(t,n)})});let m=document.getElementById(`login-form`);m&&m.addEventListener(`submit`,e=>{e.preventDefault(),Be()});let h=document.getElementById(`update-password-form`);h&&h.addEventListener(`submit`,e=>{e.preventDefault(),We()});let g=document.getElementById(`auth-btn`);g&&g.addEventListener(`click`,()=>{w(`currentUser`)?Ge():(ze(),Ie())});let _=document.getElementById(`confirm-winner-btn`);_&&_.addEventListener(`click`,()=>{let e=_.getAttribute(`data-game-id`);e&&Li(e)});let v=document.getElementById(`sort-dropdown-menu`);v&&v.addEventListener(`click`,e=>{let t=e.target.closest(`[data-action="select-sort"]`);t&&or(t.getAttribute(`data-sort-key`),t.getAttribute(`data-sort-asc`)===`true`)});let y=document.getElementById(`filter-drawer-left`);y&&y.addEventListener(`change`,e=>{let t=e.target.closest(`input[type="checkbox"][data-type]`);t&&Hn(t)});let b=document.getElementById(`drawer-body-content`);b&&(b.addEventListener(`click`,e=>{let t=e.target,n=t.closest(`[data-action="toggle-drawer-player-filter"]`);if(n){Xn(parseInt(n.getAttribute(`data-player-idx`),10));return}let r=t.closest(`[data-action="toggle-staged-player-game-filter"]`);if(r){Kn(parseInt(r.getAttribute(`data-player-idx`),10));return}let i=t.closest(`[data-action="drawer-sort-player-change"]`);if(i){Yn(parseInt(i.getAttribute(`data-player-idx`),10));return}let a=t.closest(`[data-action="toggle-drawer-level"]`);if(a){if(a.getAttribute(`data-disabled`)===`true`)return;let e=a.getAttribute(`data-level`);Zn(e===`all`?`all`:parseInt(e,10));return}let o=t.closest(`[data-action="toggle-drawer-group"]`);if(o){if(o.getAttribute(`data-disabled`)===`true`)return;Qn(o.getAttribute(`data-group-id`));return}}),b.addEventListener(`change`,e=>{let t=e.target,n=t.closest(`[data-action="toggle-use-historical"]`);if(n){qn(n.checked);return}let r=t.closest(`[data-action="toggle-staged-winner-only"]`);if(r){Ln(r.checked);return}let i=t.closest(`[data-action="drawer-sort-type-change"]`);if(i){Jn(i.value);return}let a=t.closest(`[data-action="toggle-staged-ban"]`);if(a){Dn(a.getAttribute(`data-hero-id`));return}}),b.addEventListener(`input`,e=>{let t=e.target.closest(`[data-action="ban-search-input"]`);t&&On(t.value)}));let x=document.getElementById(`active-filters-container`);x&&x.addEventListener(`click`,e=>{let t=e.target;if(t.closest(`[data-action="clear-search-filter"]`)){fr();return}let n=t.closest(`[data-action="remove-filter-chip"]`);if(n){let e=n.getAttribute(`data-type`),t=n.getAttribute(`data-value`);e===`complexity`&&(t=parseInt(t,10)),dr(e,t);return}});let ee=document.getElementById(`results`);ee&&ee.addEventListener(`click`,e=>{let t=e.target,n=t.closest(`[data-action="open-hero-select"]`);if(n){_n(parseInt(n.getAttribute(`data-player-idx`),10));return}let r=t.closest(`[data-action="select-draft-candidate"]`);if(r){Fn(parseInt(r.getAttribute(`data-player-idx`),10),r.getAttribute(`data-hero-id`));return}if(t.closest(`[data-action="cancel-roll"]`)){En();return}let i=t.closest(`[data-action="confirm-draft"]`);if(i){In(parseInt(i.getAttribute(`data-player-idx`),10));return}});let te=document.getElementById(`hero-select-options-container`);te&&te.addEventListener(`click`,e=>{let t=e.target.closest(`[data-action="select-hero-option"]`);t&&xn(t.getAttribute(`data-hero-name`))});let ne=document.getElementById(`heroContainer`);ne&&ne.addEventListener(`click`,e=>{let t=e.target.closest(`[data-action="toggle-hero-panel"]`);if(t){if(e.target.closest(`a`)||e.target.closest(`.complexity-dice-bar`))return;ei(t)}});let re=document.getElementById(`groupsListContainer`);re&&re.addEventListener(`click`,e=>{let t=e.target,n=t.getAttribute(`data-group-id`);t.closest(`[data-action="edit-group"]`)?_i(n):t.closest(`[data-action="delete-group"]`)?ki(n):t.closest(`[data-action="save-group-inline"]`)?yi(n):t.closest(`[data-action="cancel-group-edit"]`)&&vi(n)});let ie=document.getElementById(`heroesListContainer`);ie&&ie.addEventListener(`click`,e=>{let t=e.target;t.closest(`[data-action="edit-hero"]`)?oi(parseInt(t.getAttribute(`data-hero-idx`),10)):t.closest(`[data-action="delete-hero"]`)?hi(t.getAttribute(`data-hero-id`)):t.closest(`[data-action="save-hero-inline"]`)?mi(t.getAttribute(`data-hero-id`),parseInt(t.getAttribute(`data-hero-idx`),10)):t.closest(`[data-action="cancel-hero-edit"]`)&&pi()});let S=document.getElementById(`playersListContainer`);S&&(S.addEventListener(`click`,e=>{let t=e.target,n=t.getAttribute(`data-player-id`);t.closest(`[data-action="edit-player"]`)?Ci(n):t.closest(`[data-action="save-player-inline"]`)?Ti(n):t.closest(`[data-action="cancel-player-edit"]`)&&wi(n)}),S.addEventListener(`change`,e=>{let t=e.target.closest(`[data-action="player-color-change"]`);t&&Ji(t.getAttribute(`data-player-id`),t)}));let C=document.getElementById(`usersListContainer`);C&&C.addEventListener(`change`,e=>{e.target.closest(`[data-action="user-role-change"]`)&&(alert(`User roles must be modified directly in the Supabase Dashboard for security reasons.`),Ei())});let ae=e=>{e&&(e.addEventListener(`click`,e=>{let t=e.target,n=t.closest(`[data-action="toggle-hero-owned"]`);if(n){ri(n.getAttribute(`data-hero-id`),n.getAttribute(`data-selected`)!==`true`);return}let r=t.closest(`[data-action="toggle-collection-group"]`);if(r){if(e.target.closest(`input[type="checkbox"]`)||e.target.closest(`label`))return;ti(r.getAttribute(`data-group-id`),e);return}}),e.addEventListener(`change`,e=>{let t=e.target,n=t.closest(`[data-action="toggle-group-owned"]`);if(n){ii(n.getAttribute(`data-group-id`),n.checked);return}let r=t.closest(`[data-action="toggle-user-hero-owned"]`);if(r){Oi(r.getAttribute(`data-user-id`),r.getAttribute(`data-hero-id`),r.checked);return}}))};ae(document.getElementById(`collectionsListContainer`)),ae(document.getElementById(`collectionContainer`));let oe=document.getElementById(`gamesSection`);oe&&oe.addEventListener(`click`,e=>{let t=e.target;if(t.closest(`[data-action="toggle-history-view-style"]`)){Pi();return}let n=t.closest(`[data-action="toggle-game-expansion"]`);if(n){Ni(n.getAttribute(`data-game-id`));return}let r=t.closest(`[data-action="select-winner"]`);if(r){Fi(r.getAttribute(`data-game-id`));return}let i=t.closest(`[data-action="delete-game"]`);if(i){Ri(i.getAttribute(`data-game-id`));return}let a=t.closest(`[data-action="open-winner-modal"]`);if(a){Fi(a.getAttribute(`data-game-id`));return}});let se=document.getElementById(`winner-selection-container`);se&&se.addEventListener(`click`,e=>{let t=e.target.closest(`[data-action="winner-card-click"]`);if(t){let e=t.querySelector(`input[name="winner-selection"]`);if(e){e.checked=!0,se.querySelectorAll(`.winner-card, .winner-draw-card`).forEach(e=>{e.classList.toggle(`selected`,e===t)});let n=document.getElementById(`confirm-winner-btn`);n&&(n.disabled=!1)}}}),window.addEventListener(`click`,e=>{let t=document.getElementById(`changelog-modal`),n=document.getElementById(`login-modal`),r=document.getElementById(`whats-new-modal`),i=document.getElementById(`update-password-modal`),a=document.getElementById(`hero-select-modal`),o=document.getElementById(`account-modal`);e.target===t&&Yr(),e.target===n&&Le(),e.target===r&&Zr(),e.target===i&&Ue(),e.target===a&&vn(),e.target===o&&ze();let s=document.getElementById(`sort-dropdown-menu`),c=document.getElementById(`sort-dropdown-container`);s&&s.classList.contains(`show`)&&c&&!c.contains(e.target)&&ar()}),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&vn()})}async function $(){T(`draftModeEnabled`,localStorage.getItem(`draftModeEnabled`)===`true`);let e=parseInt(localStorage.getItem(`draftCount`)||`3`,10);[2,3,4,5].includes(e)||(e=3),T(`draftCount`,e);let t=localStorage.getItem(`bannedHeroIds`);T(`bannedHeroIds`,t?new Set(JSON.parse(t)):new Set),kn();let{data:n,error:r}=await m();if(!r&&n){T(`groups`,n),ui(),di();let e=new Set(n.map(e=>e.id));if(w(`activeGroups`).size===0)n.forEach(e=>E(`activeGroups`,`add`,e.id));else for(let t of w(`activeGroups`))e.has(t)||E(`activeGroups`,`delete`,t);V(),ur()}let{data:i,error:a}=await h();if(!a&&i){T(`players`,i),i.forEach(e=>{e.player_color&&Ui(e.id,Vi(e.player_color))});let e=i.map(e=>e.name),t=-1,n=w(`currentUser`);i.forEach((r,i)=>{i<6&&(e[i]=r.name,n&&r.user_id===n.id&&(t=i))}),T(`NAMES`,e),T(`loggedInPlayerIndex`,t),Pe(),Fe(),lt()}let{data:o,error:s}=await g();if(s)return console.error(`Error fetching heroes:`,s);T(`characters`,o.map(e=>{let t=e.user_heroes?.find(e=>e.user_id===w(`currentUser`)?.id),n=t?t.is_owned:!0,r={id:e.id,name:e.name,slug:e.slug,complexity:e.complexity,group_id:e.group_id,is_owned:n,group:e.groups?.name||`Unknown`,weights:[,,,,].fill(250),playCount:[,,,,].fill(0),lastPlayed:[,,,,].fill(`Never`),winCount:[,,,,].fill(0)};return e.player_hero_stats?.forEach(e=>{let t=parseInt(e.player_id.substring(1))-1;t>=0&&t<4&&(r.weights[t]=e.weight)}),r}));let{data:c,error:l}=await _();l?console.error(`Error fetching games:`,l):T(`games`,c.map(e=>({...e,game_players:(e.game_players||[]).slice().sort((e,t)=>parseInt(e.player_id?.substring(1)||`0`,10)-parseInt(t.player_id?.substring(1)||`0`,10))}))),Ai(),qr(),di(),G(),fi(),Si(),Ei(),K()&&Di(),W();let u=w(`currentSort`);T(`currentSort`,null),nr(u)}async function $i(){try{let{data:{session:e}}=await f();T(`currentUser`,e?.user||null),Pe(),await $(),T(`cachedChangelog`,await(await fetch(`changelog.json`)).json());let t=w(`cachedChangelog`);if(t&&t.length>0){let e=t[0],n=document.getElementById(`version-number`);n&&(n.innerText=e.version);let r=localStorage.getItem(`lastSeenVersion`);if(r!==e.version){let n=t.findIndex(e=>e.version===r);Xr(n===-1?[e]:t.slice(0,n))}}de($),me((e,t)=>{console.log(`[stateStore] Update: ${e} =`,t)})}catch(e){console.error(`Could not load version number:`,e);let t=document.getElementById(`version-number`);t&&(t.innerText=`Error`)}finally{ea()}}function ea(){let e=document.getElementById(`preloader`);e&&(e.classList.add(`fade-out`),document.body.classList.add(`loaded`),e.addEventListener(`animationend`,()=>e.remove(),{once:!0}))}window.addEventListener(`DOMContentLoaded`,()=>{Qi(),$i(),p((e,t)=>{T(`currentUser`,t?.user||null),(e===`SIGNED_IN`||e===`SIGNED_OUT`)&&$(),e===`PASSWORD_RECOVERY`&&He(),Pe(),e===`SIGNED_IN`&&Le()})});